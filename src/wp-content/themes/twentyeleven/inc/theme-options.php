 ...
 */
function twentyeleven_admin_enqueue_scripts($hook_suffix): void
{
 ...
 * @since Twenty Eleven 1.0
 */
function twentyeleven_theme_options_init(): void
{
 ...
 */
function twentyeleven_option_page_capability($capability): string
{
 ...
 * @since Twenty Eleven 1.0
 */
function twentyeleven_theme_options_add_page(): void
{
 ...
 */
function twentyeleven_theme_options_help(): void
{
 ...
 * @since Twenty Eleven 1.3
 */
function twentyeleven_settings_field_color_scheme(): void
{
    $options = twentyeleven_get_theme_options();
 ...
 * @since Twenty Eleven 1.3
 */
function twentyeleven_settings_field_link_color(): void
{
    $options = twentyeleven_get_theme_options();
    ?>
 ...
 * @since Twenty Eleven 1.3
 */
function twentyeleven_settings_field_layout(): void
{
    $options = twentyeleven_get_theme_options();
 ...
 */
function twentyeleven_theme_options_render_page(): void
{
 ...
 */
function twentyeleven_theme_options_validate(array $input)
{
 ...
 * @since Twenty Eleven 1.0
 */
function twentyeleven_enqueue_color_scheme(): void
{
    $options      = twentyeleven_get_theme_options();
    $color_scheme = $options['color_scheme'];

    if ('dark' === $color_scheme) {
        wp_enqueue_style('dark', get_template_directory_uri() . '/colors/dark.css', [], '20251017');
    }
 ...
 * @since Twenty Eleven 1.0
 */
function twentyeleven_print_link_color_style(): void
{
    $options    = twentyeleven_get_theme_options();
 ...
 */
function twentyeleven_layout_classes($existing_classes): array
{
    $options        = twentyeleven_get_theme_options();
 ...
 */
function twentyeleven_customize_register($wp_customize): void
{
 ...
 */
function twentyeleven_customize_partial_blogname(): void
{
    bloginfo('name');
}
 ...
 * @see twentyeleven_customize_register()
 */
function twentyeleven_customize_partial_blogdescription(): void
{
 ...
 * @since Twenty Eleven 1.3
 */
function twentyeleven_customize_preview_js(): void
{
