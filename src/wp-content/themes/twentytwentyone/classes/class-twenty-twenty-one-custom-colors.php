...
class Twenty_Twenty_One_Custom_Colors
{
     ...
     */
    public function custom_get_readable_color($background_color): string
    {
     ...
     */
    public function generate_custom_color_variables($context = null): string
    {
     ...
     * @since Twenty Twenty-One 1.0
     */
    public function custom_color_variables(): void
    {
     ...
     */
    public static function get_relative_luminance_from_hex($hex): int
    {
