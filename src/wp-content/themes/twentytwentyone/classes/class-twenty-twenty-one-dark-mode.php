...
class Twenty_Twenty_One_Dark_Mode
{
     ...
     * @since Twenty Twenty-One 1.0
     */
    public function editor_custom_color_variables(): void
    {
    ...
    public function enqueue_scripts(): void
    {
        ...
        wp_enqueue_style('tt1-dark-mode', $url, [ 'twenty-twenty-one-style' ], wp_get_theme()->get('Version'));
    }
     ...
     */
    public function customizer_controls($wp_customize): void
    {
        ...
        $wp_customize->add_control(
            new Twenty_Twenty_One_Customize_Notice_Control(
                ...
                [
                    'section'         => 'colors',
                    'priority'        => 100,
                    'active_callback' => static fn () => 127 >= Twenty_Twenty_One_Custom_Colors::get_relative_luminance_from_hex(get_theme_mod('background_color', 'D1E4DD')),
                ]
            )
        );
        ...
        $wp_customize->add_control(
            ...
            [
                ...
                'active_callback' => static fn ($value) => 127 < Twenty_Twenty_One_Custom_Colors::get_relative_luminance_from_hex(get_theme_mod('background_color', 'D1E4DD')),
            ]
        );
     ...
     * @global bool $is_IE
     */
    public function switch_should_render(): bool
    {
        global $is_IE;
        return (
     ...
     * @since Twenty Twenty-One 1.0
     */
    public function the_switch(): void
    {
        if (! $this->switch_should_render()) {
            return;
        }
     ...
     */
    public function the_html($attrs = []): void
    {
        $attrs = wp_parse_args(
            $attrs,
            [
     ...
     * @since Twenty Twenty-One 1.0
     */
    public function the_script(): void
    {
