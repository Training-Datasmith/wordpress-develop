 ...
 * @since Twenty Twenty-One 1.0
 */
function twenty_twenty_one_pingback_header(): void
{
 ...
 * @since Twenty Twenty-One 1.0
 */
function twenty_twenty_one_supports_js(): void
{
 ...
 */
function twenty_twenty_one_comment_form_defaults(array $defaults): array
{
 ...
 * @since Twenty Twenty-One 1.0
 */
function twenty_twenty_one_get_avatar_size(): int
{
    return 60;
}
 ...
 * @since Twenty Twenty-One 1.0
 */
function twenty_twenty_one_continue_reading_text(): string
{
    return sprintf(
 ...
 */
function twenty_twenty_one_change_calendar_nav_arrows($calendar_output): string
{
    ...
    return str_replace(' &raquo;', is_rtl() ? twenty_twenty_one_get_icon_svg('ui', 'arrow_left') : twenty_twenty_one_get_icon_svg('ui', 'arrow_right'), $calendar_output);
}
 ...
 */
function twenty_twenty_one_get_non_latin_css($type = 'front-end'): string
{
 ...
 */
function twenty_twenty_one_print_first_instance_of_block($block_name, $content = null, $instances = 1): bool
{
    $instances_count = 0;
    $blocks_content  = '';
 ...
 */
function twenty_twenty_one_password_form($output, $post = 0): string
{
    $post   = get_post($post);
    $label  = 'pwbox-' . (empty($post->ID) ? wp_rand() : $post->ID);
    return '<p class="post-password-message">' . esc_html__('This content is password protected. Please enter a password to view.', 'twentytwentyone') . '</p>
 ...
 */
function twenty_twenty_one_get_attachment_image_attributes(array $attr, $attachment, $size)
{
