 ...
 */
function twentyseventeen_setup(): void
{
 ...
 */
function twentyseventeen_content_width(): void
{
 ...
 */
function twentyseventeen_widgets_init(): void
{
    register_sidebar(
        [
 ...
 * @since Twenty Seventeen 1.0
 */
function twentyseventeen_javascript_detection(): void
{
 ...
 */
function twentyseventeen_pingback_header(): void
{
 ...
 */
function twentyseventeen_colors_css_wrap(): void
{
 ...
 * @since Twenty Seventeen 1.0
 */
function twentyseventeen_scripts(): void
{
    ...
    // Theme stylesheet.
    wp_enqueue_style('twentyseventeen-style', get_stylesheet_uri(), [], '20251202');
    ...
    if (is_customize_preview()) {
        wp_register_style('twentyseventeen-ie9', false, [ 'twentyseventeen-style' ]);
    }
    wp_register_style('twentyseventeen-ie8', false, [ 'twentyseventeen-style' ]);
 ...
 */
function twentyseventeen_block_editor_styles(): void
{
    // Block styles.
 ...
 */
function twentyseventeen_content_image_sizes_attr($sizes, array $size)
{
    $width = $size[0];
 ...
 */
function twentyseventeen_header_image_tag($html, $header, array $attr)
{
    if (isset($attr['sizes'])) {
        return str_replace($attr['sizes'], '(max-width: 767px) 200vw, 100vw', $html);
    }
    return $html;
}
 ...
 */
function twentyseventeen_post_thumbnail_sizes_attr(array $attr, $attachment, $size): array
{
 ...
 */
function twentyseventeen_widget_tag_cloud_args(array $args): array
{
    $args['largest']  = 1;
    $args['smallest'] = 1;
    $args['unit']     = 'em';
 ...
 */
function twentyseventeen_unique_id(string $prefix = '')
{
    static $id_counter = 0;
 ...
 */
function twentyseventeen_register_block_patterns(): void
{
