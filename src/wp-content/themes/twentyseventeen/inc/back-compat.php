 ...
 * @since Twenty Seventeen 1.0
 */
function twentyseventeen_switch_theme(): void
{
 ...
 */
function twentyseventeen_upgrade_notice(): void
{
    printf(
 ...
 * @global string $wp_version WordPress version.
 */
function twentyseventeen_customize(): void
{
    wp_die(
        sprintf(
            /* translators: %s: The current WordPress version. */
 ...
 * @global string $wp_version WordPress version.
 */
function twentyseventeen_preview(): void
{
