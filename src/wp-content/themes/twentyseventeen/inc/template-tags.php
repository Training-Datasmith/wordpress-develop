...
if (! function_exists('twentyseventeen_posted_on')) :
     ...
     */
    function twentyseventeen_posted_on(): void
    {
...
if (! function_exists('twentyseventeen_time_link')) :
     ...
     */
    function twentyseventeen_time_link(): string
    {
...
if (! function_exists('twentyseventeen_entry_footer')) :
     ...
     */
    function twentyseventeen_entry_footer(): void
    {
...
if (! function_exists('twentyseventeen_edit_link')) :
     ...
     */
    function twentyseventeen_edit_link(): void
    {
        edit_post_link(
            sprintf(
 ...
 */
function twentyseventeen_front_page_section($partial = null, $id = 0): void
{
 ...
 */
function twentyseventeen_category_transient_flusher(): void
{
