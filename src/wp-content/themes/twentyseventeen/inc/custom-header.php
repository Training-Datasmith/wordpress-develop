 ...
 */
function twentyseventeen_custom_header_setup(): void
{
...
if (! function_exists('twentyseventeen_header_style')) :
     ...
     */
    function twentyseventeen_header_style(): void
    {
 ...
 */
function twentyseventeen_video_controls(array $settings): array
{
