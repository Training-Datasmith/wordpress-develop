    ...
    class TwentyTwenty_Customize
    {
        ...
        public static function register($wp_customize): void
        {
            ...
            $wp_customize->add_setting(
                ...
                [
                    'capability'        => 'edit_theme_options',
                    'sanitize_callback' => [ self::class, 'sanitize_select' ],
                    'transport'         => 'postMessage',
                    'default'           => 'default',
                ]
            );
            ...
            $wp_customize->add_setting(
                ...
                [
                    ...
                    'type'              => 'theme_mod',
                    'transport'         => 'postMessage',
                    'sanitize_callback' => [ self::class, 'sanitize_accent_accessible_colors' ],
                ]
            );
            ...
            $wp_customize->add_control(
                new WP_Customize_Color_Control(
                    ...
                    [
                        ...
                        'mode'            => 'hue',
                        'active_callback' => static fn () => 'custom' === $wp_customize->get_setting('accent_hue_active')->value(),
                    ]
                )
            );
