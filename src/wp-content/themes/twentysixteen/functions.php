...
if (! function_exists('twentysixteen_setup')) :
     ...
     * @since Twenty Sixteen 1.0
     */
    function twentysixteen_setup(): void
    {
        /*
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_content_width(): void
{
    /**
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_widgets_init(): void
{
    register_sidebar(
        [
...
if (! function_exists('twentysixteen_fonts_url')) :
     ...
     */
    function twentysixteen_fonts_url(): string
    {
        $fonts_url = '';
        $fonts     = [];
        ...
        if ($fonts) {
            return get_template_directory_uri() . '/fonts/' . implode('-plus-', $fonts) . '.css';
        }
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_javascript_detection(): void
{
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_scripts(): void
{
    ...
    // Theme stylesheet.
    wp_enqueue_style('twentysixteen-style', get_stylesheet_uri(), [], '20251202');
    ...
    wp_register_style('twentysixteen-ie', false, [ 'twentysixteen-style' ]);
    wp_register_style('twentysixteen-ie8', false, [ 'twentysixteen-style' ]);
    wp_register_style('twentysixteen-ie7', false, [ 'twentysixteen-style' ]);
 ...
 * @since Twenty Sixteen 1.6
 */
function twentysixteen_block_editor_styles(): void
{
    // Block styles.
    wp_enqueue_style('twentysixteen-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', [], '20250715');
    // Add custom fonts.
    $font_version = (0 === strpos((string) twentysixteen_fonts_url(), get_template_directory_uri() . '/')) ? '20230328' : null;
    wp_enqueue_style('twentysixteen-fonts', twentysixteen_fonts_url(), [], $font_version);
}
 ...
 */
function twentysixteen_hex2rgb($color): array
{
    $color = trim($color, '#');
 ...
 */
function twentysixteen_register_block_patterns(): void
{
 ...
 */
function twentysixteen_content_image_sizes_attr($sizes, array $size)
{
    $width = $size[0];
 ...
 */
function twentysixteen_post_thumbnail_sizes_attr(array $attr, $attachment, $size): array
{
 ...
 */
function twentysixteen_widget_tag_cloud_args(array $args): array
{
    $args['largest']  = 1;
    $args['smallest'] = 1;
    $args['unit']     = 'em';
