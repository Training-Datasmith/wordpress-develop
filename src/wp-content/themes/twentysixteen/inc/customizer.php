 ...
 */
function twentysixteen_custom_header_and_background(): void
{
...
if (! function_exists('twentysixteen_header_style')) :
     ...
     */
    function twentysixteen_header_style(): void
    {
 ...
 */
function twentysixteen_customize_register($wp_customize): void
{
    $color_scheme = twentysixteen_get_color_scheme();
 ...
 */
function twentysixteen_customize_partial_blogname(): void
{
    bloginfo('name');
}
 ...
 * @see twentysixteen_customize_register()
 */
function twentysixteen_customize_partial_blogdescription(): void
{
...
if (! function_exists('twentysixteen_get_color_scheme_choices')) :
     ...
     */
    function twentysixteen_get_color_scheme_choices(): array
    {
        $color_schemes                = twentysixteen_get_color_schemes();
...
if (! function_exists('twentysixteen_sanitize_color_scheme')) :
     ...
     */
    function twentysixteen_sanitize_color_scheme($value): string
    {
 ...
 */
function twentysixteen_color_scheme_css(): void
{
    $color_scheme_option = get_theme_mod('color_scheme', 'default');
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_customize_control_js(): void
{
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_customize_preview_js(): void
{
 ...
 */
function twentysixteen_get_color_scheme_css($colors): string
{
 ...
 */
function twentysixteen_color_scheme_css_template(): void
{
    $colors = [
 ...
 * @see wp_add_inline_style()
 */
function twentysixteen_page_background_color_css(): void
{
    $color_scheme          = twentysixteen_get_color_scheme();
 ...
 * @see wp_add_inline_style()
 */
function twentysixteen_link_color_css(): void
{
    $color_scheme  = twentysixteen_get_color_scheme();
 ...
 * @see wp_add_inline_style()
 */
function twentysixteen_main_text_color_css(): void
{
    $color_scheme    = twentysixteen_get_color_scheme();
 ...
 * @see wp_add_inline_style()
 */
function twentysixteen_secondary_text_color_css(): void
{
    $color_scheme         = twentysixteen_get_color_scheme();
