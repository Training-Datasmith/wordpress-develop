...
if (! function_exists('twentysixteen_entry_meta')) :
     ...
     * @since Twenty Sixteen 1.0
     */
    function twentysixteen_entry_meta(): void
    {
...
if (! function_exists('twentysixteen_entry_date')) :
     ...
     * @since Twenty Sixteen 1.0
     */
    function twentysixteen_entry_date(): void
    {
...
if (! function_exists('twentysixteen_entry_taxonomies')) :
     ...
     * @since Twenty Sixteen 1.0
     */
    function twentysixteen_entry_taxonomies(): void
    {
...
if (! function_exists('twentysixteen_post_thumbnail')) :
     ...
     * @since Twenty Sixteen 1.0
     */
    function twentysixteen_post_thumbnail(): void
    {
...
if (! function_exists('twentysixteen_excerpt')) :
     ...
     */
    function twentysixteen_excerpt($css_class = 'entry-summary'): void
    {
...
if (! function_exists('twentysixteen_excerpt_more') && ! is_admin()) :
     ...
     */
    function twentysixteen_excerpt_more(): string
    {
        $link = sprintf(
...
if (! function_exists('twentysixteen_categorized_blog')) :
     ...
     */
    function twentysixteen_categorized_blog(): bool
    {
 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_category_transient_flusher(): void
{
...
if (! function_exists('twentysixteen_the_custom_logo')) :
     ...
     */
    function twentysixteen_the_custom_logo(): void
    {
