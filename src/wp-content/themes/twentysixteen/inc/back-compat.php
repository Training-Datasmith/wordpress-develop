 ...
 * @since Twenty Sixteen 1.0
 */
function twentysixteen_switch_theme(): void
{
 ...
 */
function twentysixteen_upgrade_notice(): void
{
    printf(
 ...
 * @global string $wp_version WordPress version.
 */
function twentysixteen_customize(): void
{
    wp_die(
        sprintf(
            /* translators: %s: The current WordPress version. */
 ...
 * @global string $wp_version WordPress version.
 */
function twentysixteen_preview(): void
{
