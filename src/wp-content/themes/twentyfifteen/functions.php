...
if (! function_exists('twentyfifteen_setup')) :
     ...
     * @since Twenty Fifteen 1.0
     */
    function twentyfifteen_setup(): void
    {
 ...
 */
function twentyfifteen_widgets_init(): void
{
    register_sidebar(
        [
...
if (! function_exists('twentyfifteen_fonts_url')) :
     ...
     */
    function twentyfifteen_fonts_url(): string
    {
        $fonts_url = '';
        $fonts     = [];
        ...
        if ($fonts) {
            return get_template_directory_uri() . '/assets/fonts/' . implode('-plus-', $fonts) . '.css';
        }
 ...
 */
function twentyfifteen_javascript_detection(): void
{
 ...
 * @since Twenty Fifteen 1.0
 */
function twentyfifteen_scripts(): void
{
    ...
    wp_enqueue_style('twentyfifteen-style', get_stylesheet_uri(), [], '20251202');
    ...
    wp_register_style('twentyfifteen-ie', false, [ 'twentyfifteen-style' ]);
    wp_register_style('twentyfifteen-ie7', false, [ 'twentyfifteen-style' ]);
 ...
 */
function twentyfifteen_block_editor_styles(): void
{
    // Block styles.
 ...
 */
function twentyfifteen_post_nav_background(): void
{
    if (! is_single()) {
        return;
    }
...
function twentyfifteen_nav_description($item_output, $item, $depth, $args)
{
    if ('primary' === $args->theme_location && $item->description) {
        return str_replace($args->link_after . '</a>', '<div class="menu-item-description">' . $item->description . '</div>' . $args->link_after . '</a>', $item_output);
    }
 ...
 */
function twentyfifteen_search_form_modify($html): string
{
 ...
 */
function twentyfifteen_widget_tag_cloud_args(array $args): array
{
    $args['largest']  = 22;
    $args['smallest'] = 8;
    $args['unit']     = 'pt';
 ...
 */
function twentyfifteen_register_block_patterns(): void
{
