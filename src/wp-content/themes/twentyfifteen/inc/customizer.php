 ...
 */
function twentyfifteen_customize_register($wp_customize): void
{
 ...
 */
function twentyfifteen_customize_partial_blogname(): void
{
    bloginfo('name');
}
 ...
 * @see twentyfifteen_customize_register()
 */
function twentyfifteen_customize_partial_blogdescription(): void
{
...
if (! function_exists('twentyfifteen_get_color_scheme_choices')) :
     ...
     */
    function twentyfifteen_get_color_scheme_choices(): array
    {
        $color_schemes                = twentyfifteen_get_color_schemes();
...
if (! function_exists('twentyfifteen_sanitize_color_scheme')) :
     ...
     */
    function twentyfifteen_sanitize_color_scheme($value): string
    {
 ...
 */
function twentyfifteen_color_scheme_css(): void
{
    $color_scheme_option = get_theme_mod('color_scheme', 'default');
 ...
 * @since Twenty Fifteen 1.0
 */
function twentyfifteen_customize_control_js(): void
{
    wp_enqueue_script('color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', [ 'customize-controls', 'iris', 'underscore', 'wp-util' ], '20250729', [ 'in_footer' => true ]);
 ...
 * @since Twenty Fifteen 1.0
 */
function twentyfifteen_customize_preview_js(): void
{
 ...
 */
function twentyfifteen_get_color_scheme_css($colors): string
{
 ...
 */
function twentyfifteen_color_scheme_css_template(): void
{
    $colors = [
