 ...
 */
function twentyfifteen_custom_header_setup(): void
{
 ...
 */
function twentyfifteen_hex2rgb($color): array
{
    $color = trim($color, '#');
...
if (! function_exists('twentyfifteen_header_style')) :
     ...
     */
    function twentyfifteen_header_style(): void
    {
 ...
 */
function twentyfifteen_header_background_color_css(): void
{
    $color_scheme            = twentyfifteen_get_color_scheme();
 ...
 * @since Twenty Fifteen 1.0
 */
function twentyfifteen_sidebar_text_color_css(): void
{
    $color_scheme       = twentyfifteen_get_color_scheme();
