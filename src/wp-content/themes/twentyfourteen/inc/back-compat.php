 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_switch_theme(): void
{
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_upgrade_notice(): void
{
    printf(
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_customize(): void
{
    wp_die(
        sprintf(
            /* translators: %s: WordPress version. */
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_preview(): void
{
