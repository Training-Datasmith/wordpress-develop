...
class Featured_Content
{
    ...
    {
        add_action('init', [ self::class, 'init' ], 30);
    }
    ...
    public static function init(): void
    {
        ...
        add_filter($filter, [ self::class, 'get_featured_posts' ]);
        add_action('customize_register', [ self::class, 'customize_register' ], 9);
        add_action('admin_init', [ self::class, 'register_setting' ]);
        add_action('switch_theme', [ self::class, 'delete_transient' ]);
        add_action('save_post', [ self::class, 'delete_transient' ]);
        add_action('delete_post_tag', [ self::class, 'delete_post_tag' ]);
        add_action('customize_controls_enqueue_scripts', [ self::class, 'enqueue_scripts' ]);
    ...
    public static function wp_loaded(): void
    {
        if (self::get_setting('hide-tag')) {
            add_filter('get_terms', [ self::class, 'hide_featured_term' ], 10, 3);
            add_filter('get_the_terms', [ self::class, 'hide_the_featured_term' ], 10, 3);
        }
    }
     ...
     */
    public static function get_featured_post_ids(): array
    {
     ...
     */
    public static function delete_post_tag($tag_id): void
    {
        $settings = self::get_setting();
     ...
     */
    public static function hide_featured_term($terms, $taxonomies, array $args)
    {
    ...
    {
        register_setting('featured-content', 'featured-content', [ self::class, 'validate_settings' ]);
    }
    ...
    public static function customize_register($wp_customize): void
    {
        ...
        $wp_customize->add_setting(
            ...
            [
                ...
                'type'                 => 'option',
                'sanitize_js_callback' => [ self::class, 'delete_transient' ],
            ]
        );
        $wp_customize->add_setting(
