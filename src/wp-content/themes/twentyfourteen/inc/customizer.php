 ...
 */
function twentyfourteen_customize_register($wp_customize): void
{
 ...
 */
function twentyfourteen_customize_partial_blogname(): void
{
    bloginfo('name');
}
 ...
 * @see twentyfourteen_customize_register()
 */
function twentyfourteen_customize_partial_blogdescription(): void
{
 ...
 */
function twentyfourteen_sanitize_layout($layout): string
{
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_customize_preview_js(): void
{
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_contextual_help(): void
{
