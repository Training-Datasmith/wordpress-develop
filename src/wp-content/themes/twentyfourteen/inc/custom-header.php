 ...
 */
function twentyfourteen_custom_header_setup(): void
{
    add_theme_support(
        'custom-header',
        /**
...
if (! function_exists('twentyfourteen_header_style')) :
     ...
     */
    function twentyfourteen_header_style(): void
    {
...
if (! function_exists('twentyfourteen_admin_header_style')) :
     ...
     * @since Twenty Fourteen 1.0
     */
    function twentyfourteen_admin_header_style(): void
    {
        ?>
...
if (! function_exists('twentyfourteen_admin_header_image')) :
     ...
     * @since Twenty Fourteen 1.0
     */
    function twentyfourteen_admin_header_image(): void
    {
        ?>
	<div id="headimg">
...
if (! function_exists('twentyfourteen_header_image')) :
     ...
     */
    function twentyfourteen_header_image(): void
    {
