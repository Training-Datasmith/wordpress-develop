...
if (! function_exists('twentyfourteen_setup')) :
     ...
     * @since Twenty Fourteen 1.0
     */
    function twentyfourteen_setup(): void
    {
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_content_width(): void
{
 ...
 */
function twentyfourteen_has_featured_posts(): bool
{
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_widgets_init(): void
{
...
if (! function_exists('twentyfourteen_font_url')) :
     ...
     */
    function twentyfourteen_font_url(): string
    {
        /*
        ...
        if ('off' !== _x('on', 'Lato font: on or off', 'twentyfourteen')) {
            return get_template_directory_uri() . '/fonts/font-lato.css';
        }
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_scripts(): void
{
    ...
    wp_enqueue_style('twentyfourteen-style', get_stylesheet_uri(), [], '20251202');

    // Theme block stylesheet.
    wp_enqueue_style('twentyfourteen-block-style', get_template_directory_uri() . '/css/blocks.css', [ 'twentyfourteen-style' ], '20250715');

    // Register the Internet Explorer specific stylesheet.
    wp_register_style('twentyfourteen-ie', false, [ 'twentyfourteen-style' ]);
 ...
 * @since Twenty Fourteen 1.0
 */
function twentyfourteen_admin_fonts(): void
{
    $font_version = (0 === strpos((string) twentyfourteen_font_url(), get_template_directory_uri() . '/')) ? '20230328' : null;
    wp_enqueue_style('twentyfourteen-lato', twentyfourteen_font_url(), [], $font_version);
}
 ...
 */
function twentyfourteen_block_editor_styles(): void
{
    // Block styles.
...
if (! function_exists('twentyfourteen_the_attached_image')) :
     ...
     * @since Twenty Fourteen 1.0
     */
    function twentyfourteen_the_attached_image(): void
    {
        $post = get_post();
        /**
...
if (! function_exists('twentyfourteen_list_authors')) :
     ...
     * @since Twenty Fourteen 1.0
     */
    function twentyfourteen_list_authors(): void
    {
        $args = [
            'fields'     => 'ID',
            'orderby'    => 'post_count',
...
function twentyfourteen_wp_title($title, $sep)
{
    ...
    if (($paged >= 2 || $page >= 2) && ! is_404()) {
        ...
        return "$title $sep " . sprintf(__('Page %s', 'twentyfourteen'), max($paged, $page));
    }
 ...
 */
function twentyfourteen_widget_tag_cloud_args(array $args): array
{
    $args['largest']  = 22;
    $args['smallest'] = 8;
    $args['unit']     = 'pt';
 ...
 */
function twentyfourteen_register_block_patterns(): void
{
