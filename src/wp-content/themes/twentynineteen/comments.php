...
} else if ('1' === (string) $discussion->responses) {
...
if (have_comments()) {
    ...
    ?>
		<ol class="comment-list">
			<?php 
    wp_list_comments(['walker' => new Twenty_Nineteen_walker_comment(), 'avatar_size' => twentynineteen_get_avatar_size(), 'short_ping' => true, 'style' => 'ol']);
    ?>
		</ol><!-- .comment-list -->
		<?php 
    ...
    if (have_comments()) {
        ...
        the_comments_navigation(['prev_text' => sprintf(
