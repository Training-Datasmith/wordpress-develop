...
if (! function_exists('twentynineteen_posted_on')) :
     ...
     */
    function twentynineteen_posted_on(): void
    {
...
if (! function_exists('twentynineteen_posted_by')) :
     ...
     */
    function twentynineteen_posted_by(): void
    {
        printf(
...
if (! function_exists('twentynineteen_comment_count')) :
     ...
     */
    function twentynineteen_comment_count(): void
    {
...
if (! function_exists('twentynineteen_entry_footer')) :
     ...
     */
    function twentynineteen_entry_footer(): void
    {
...
if (! function_exists('twentynineteen_post_thumbnail')) :
     ...
     */
    function twentynineteen_post_thumbnail(): void
    {
...
if (! function_exists('twentynineteen_get_user_avatar_markup')) :
     ...
     */
    function twentynineteen_get_user_avatar_markup($id_or_email = null): string
    {
...
if (! function_exists('twentynineteen_discussion_avatars_list')) :
     ...
     */
    function twentynineteen_discussion_avatars_list($comment_authors): void
    {
...
if (! function_exists('twentynineteen_comment_form')) :
     ...
     */
    function twentynineteen_comment_form($order): void
    {
...
if (! function_exists('twentynineteen_the_posts_navigation')) :
     ...
     */
    function twentynineteen_the_posts_navigation(): void
    {
