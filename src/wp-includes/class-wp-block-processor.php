...
class WP_Block_Processor
{
    ...
    public function extract_full_block_and_advance(): ?array
    {
        ...
        $block = [
            ...
            'attrs'        => $this->allocate_and_return_parsed_attributes() ?? [],
            'innerBlocks'  => [],
            'innerHTML'    => '',
            'innerContent' => [],
        ];
     ...
     * @since 6.9.0
     */
    public const READY = 'processor-ready';
     ...
     * @since 6.9.0
     */
    public const MATCHED = 'processor-matched';
     ...
     * @since 6.9.0
     */
    public const HTML_SPAN = 'processor-html-span';
     ...
     * @since 6.9.0
     */
    public const INCOMPLETE_INPUT = 'incomplete-input';
     ...
     * @since 6.9.0
     */
    public const COMPLETE = 'processor-complete';
}
