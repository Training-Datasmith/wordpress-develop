...
class getID3
{
    ...
    public const VERSION           = '1.9.24-202509040923';
...
*/
    ...
    public function GetFileFormat(&$filedata, $filename = '')
    {
        ...
        if (preg_match('#\\.mp[cp\\+]$#i', $filename) && preg_match('#[\x00\x01\x10\x11\x40\x41\x50\x51\x80\x81\x90\x91\xC0\xC1\xD0\xD1][\x20-37][\x00\x20\x40\x60\x80\xA0\xC0\xE0]#s', $filedata)) {
     ...
     */
    public function CharConvert(array &$array, $encoding): void
    {
...
{
    protected \getID3 $getid3;                       // pointer
     ...
     * @throws getid3_exception
     */
    public function saveAttachment(string $name, $offset, $length, $image_mime = null)
    {
        $fp_dest = null;
        $dest = null;
        try {
