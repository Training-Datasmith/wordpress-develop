...
class getid3_ac3 extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if ($thisfile_ac3_raw_bsi['bsid'] <= 8) {
            ...
            if ($thisfile_ac3_raw_bsi['flags']['timecod1'] & 0x02) {
                ...
                $thisfile_ac3['timecode2'] += ($thisfile_ac3_raw_bsi['timecod2'] & 0x3800) >> 11;              // The first 3 bits of this 14-bit field represent the time in seconds, with valid values from 0�7 (representing 0-7 seconds)
     ...
     * @param int $compre
     */
    public static function heavyCompression($compre): float
    {
