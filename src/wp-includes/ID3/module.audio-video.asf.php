...
class getid3_asf extends getid3_handler
{
    ...
    public function Analyze()
    {
            ...
            switch ($NextObjectGUID) {
                ...
                case \GETID3_ASF_HEADER_EXTENSION_OBJECT:
                    ...
                    if ($thisfile_asf_headerextensionobject['reserved_1'] != \GETID3_ASF_RESERVED_1) {
                        $this->warning('header_extension_object.reserved_1 GUID ('.static::BytestringToGUID($thisfile_asf_headerextensionobject['reserved_1']).') does not match expected "GETID3_ASF_Reserved_1" GUID ('.static::BytestringToGUID(\GETID3_ASF_RESERVED_1).')');
                        //return false;
                        break;
                    }
                ...
                case \GETID3_ASF_CODEC_LIST_OBJECT:
                    ...
                    if ($thisfile_asf_codeclistobject['reserved'] != static::GUIDtoBytestring('86D15241-311D-11D0-A3A4-00A0C90348F6')) {
                        $this->warning('codec_list_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_codeclistobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {86D15241-311D-11D0-A3A4-00A0C90348F6}');
                        //return false;
                        break;
                    }
                    ...
                    for ($CodecEntryCounter = 0; $CodecEntryCounter < $thisfile_asf_codeclistobject['codec_entries_count']; $CodecEntryCounter++) {
                        ...
                        if ($thisfile_asf_codeclistobject_codecentries_current['type_raw'] == 2) { // audio codec
                            ...
                            if (strpos($thisfile_asf_codeclistobject_codecentries_current['description'], ',') === false) {
                                ...
                                [$AudioCodecBitrate, $AudioCodecFrequency, $AudioCodecChannels] = explode(',', static::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['description']));
                                ...
                                switch ($AudioCodecFrequency) {
                                    ...
                                    default:
                                        $this->warning('unknown frequency: "'.$AudioCodecFrequency.'" ('.static::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['description']).')');
                                        break;
                                }
                ...
                case \GETID3_ASF_SCRIPT_COMMAND_OBJECT:
                    ...
                    if ($thisfile_asf_scriptcommandobject['reserved'] != static::GUIDtoBytestring('4B1ACBE3-100B-11D0-A39B-00A0C90348F6')) {
                        $this->warning('script_command_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_scriptcommandobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {4B1ACBE3-100B-11D0-A39B-00A0C90348F6}');
                        //return false;
                        break;
                    }
                    ...
                    if ($thisfile_asf_scriptcommandobject['command_types_count'] > 0) {
                        ...
                        for ($CommandTypesCounter = 0; $CommandTypesCounter < (int) $thisfile_asf_scriptcommandobject['command_types_count']; $CommandTypesCounter++) {
                            ...
                            $offset += 2;
                            $thisfile_asf_scriptcommandobject['command_types'][$CommandTypesCounter] = [];
                ...
                case \GETID3_ASF_MARKER_OBJECT:
                    ...
                    if ($thisfile_asf_markerobject['reserved'] != static::GUIDtoBytestring('4CFEDB20-75F6-11CF-9C0F-00A0C90349CB')) {
                        $this->warning('marker_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_markerobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {4CFEDB20-75F6-11CF-9C0F-00A0C90349CB}');
                        break;
                    }
                    ...
                    for ($ExtendedContentDescriptorsCounter = 0; $ExtendedContentDescriptorsCounter < (int) $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count']; $ExtendedContentDescriptorsCounter++) {
                        ...
                        switch (static::TrimConvert(strtolower($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']))) {
                            ...
                            case 'artist':
                                ...
                                $thisfile_asf_comments['albumartist'] = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;

                            case 'wm/albumtitle':
                            case 'album':
                                $thisfile_asf_comments['album']  = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;

                            case 'wm/genre':
                            case 'genre':
                                $thisfile_asf_comments['genre'] = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;

                            case 'wm/partofset':
                                $thisfile_asf_comments['partofset'] = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;

                            case 'wm/tracknumber':
                            case 'tracknumber':
                                // be careful casting to int: casting unicode strings to int gives unexpected results (stops parsing at first non-numeric character)
                                $thisfile_asf_comments['track_number'] = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                            ...
                            case 'wm/track':
                                if (empty($thisfile_asf_comments['track_number'])) {
                                    $thisfile_asf_comments['track_number'] = [1 + (int) static::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                }
                                break;
                            ...
                            case 'year':
                            case 'date':
                                $thisfile_asf_comments['year'] = [ static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;

                            case 'wm/lyrics':
                            case 'lyrics':
                                $thisfile_asf_comments['lyrics'] = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                break;
                                ...
                                switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
                                    case 0: // Unicode string
                                        if (substr(static::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']), 0, 3) == 'WM/') {
                                            $thisfile_asf_comments[str_replace('wm/', '', strtolower(static::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'])))] = [static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'])];
                                        }
                                        break;
                ...
                case \GETID3_ASF_STREAM_BITRATE_PROPERTIES_OBJECT:
                    ...
                    for ($BitrateRecordsCounter = 0; $BitrateRecordsCounter < (int) $thisfile_asf_streambitratepropertiesobject['bitrate_records_count']; $BitrateRecordsCounter++) {
                        $thisfile_asf_streambitratepropertiesobject['bitrate_records'][$BitrateRecordsCounter] = [];
                ...
                default:
                    ...
                    if (static::GUIDname($NextObjectGUIDtext)) {
                        $this->warning('unhandled GUID "'.static::GUIDname($NextObjectGUIDtext).'" {'.$NextObjectGUIDtext.'} in ASF header at offset '.($offset - 16 - 8));
                    } else {
                ...
                switch ($streamdata['stream_type']) {
                    case \GETID3_ASF_AUDIO_MEDIA:
                        ...
                        if (!empty($thisfile_asf['stream_bitrate_properties_object']['bitrate_records'])) { // @phpstan-ignore-line
                            foreach ($thisfile_asf['stream_bitrate_properties_object']['bitrate_records'] as $dataarray) { // @phpstan-ignore-line
            ...
            switch ($NextObjectGUID) {
                ...
                case \GETID3_ASF_SIMPLE_INDEX_OBJECT:
                    ...
                    for ($IndexEntriesCounter = 0; $IndexEntriesCounter < $totalIndexEntriesCount; $IndexEntriesCounter++) {
                        $thisfile_asf_simpleindexobject['index_entries'][$IndexEntriesCounter]                  = [];
                ...
                case \GETID3_ASF_INDEX_OBJECT:
                    ...
                    for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter < (int) $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
                        ...
                        $offset += 2;
                        $thisfile_asf_asfindexobject['index_specifiers'][$IndexSpecifiersCounter]                    = [];
                ...
                default:
                    // Implementations shall ignore any standard or non-standard object that they do not know how to handle.
                    if (static::GUIDname($NextObjectGUIDtext)) {
                        $this->warning('unhandled GUID "'.static::GUIDname($NextObjectGUIDtext).'" {'.$NextObjectGUIDtext.'} in ASF body at offset '.($offset - 16 - 8));
                    } else {
        ...
        if (isset($thisfile_asf_codeclistobject['codec_entries']) && is_array($thisfile_asf_codeclistobject['codec_entries'])) {
            foreach ($thisfile_asf_codeclistobject['codec_entries'] as $streamdata) {
        ...
        if (!empty($thisfile_video['streams'])) {
            ...
            foreach ($thisfile_video['streams'] as $valuearray) {
        ...
        $info['bitrate'] = 0 + ($thisfile_audio['bitrate'] ?? 0) + ($thisfile_video['bitrate'] ?? 0);
    ...
    public static function GUIDtoBytestring($GUIDstring): string
    {
        ...
        return $hexbytecharstring . chr(hexdec(substr($GUIDstring, 34, 2)));
    }
    ...
    public static function WMpictureTypeLookup($WMpictureType)
    {
        ...
        if ($lookup === null) {
            ...
            $lookup = array_map(fn (string $str) => getid3_lib::iconv_fallback('UTF-8', 'UTF-16LE', $str), $lookup);
        }
        ...
        while ($objectOffset < strlen($asf_header_extension_object_data)) {
            ...
            switch ($thisObject['guid']) {
                ...
                case \GETID3_ASF_ADVANCED_MUTUAL_EXCLUSION_OBJECT:
                    ...
                    $offset += 16;
                    $thisObject['exclusion_type_text']  = static::BytestringToGUID($thisObject['exclusion_type']);
                ...
                case \GETID3_ASF_INDEX_PARAMETERS_OBJECT:
                    ...
                    for ($i = 0; $i < $thisObject['index_specifiers_count']; $i++) {
                        ...
                        $offset += 2;
                        $indexSpecifier['index_type_text'] = static::$ASFIndexParametersObjectIndexSpecifiersIndexTypes[$indexSpecifier['index_type']] ?? 'invalid'
                        ;
                ...
                case \GETID3_ASF_MEDIA_OBJECT_INDEX_PARAMETERS_OBJECT:
                    ...
                    for ($i = 0; $i < $thisObject['index_specifiers_count']; $i++) {
                        ...
                        $indexSpecifier['index_type']      = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data, $offset, 2));
                        $offset += 2;
                        $indexSpecifier['index_type_text'] = static::$ASFMediaObjectIndexParametersObjectIndexSpecifiersIndexTypes[$indexSpecifier['index_type']] ?? 'invalid'
                        ;
                ...
                case \GETID3_ASF_TIMECODE_INDEX_PARAMETERS_OBJECT:
                    ...
                    for ($i = 0; $i < $thisObject['index_specifiers_count']; $i++) {
                        ...
                        $indexSpecifier['index_type']      = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data, $offset, 2));
                        $offset += 2;
                        $indexSpecifier['index_type_text'] = static::$ASFTimecodeIndexParametersObjectIndexSpecifiersIndexTypes[$indexSpecifier['index_type']] ?? 'invalid'
                        ;
                ...
                default:
                    ...
                    if (static::GUIDname($thisObject['guid_text'])) {
                        $this->warning('unhandled Header Extension Object GUID "'.static::GUIDname($thisObject['guid_text']).'" {'.$thisObject['guid_text'].'} at offset '.($offset - 16 - 8));
                    } else {
     ...
     * @param string $string
     */
    public static function TrimConvert($string): string
    {
