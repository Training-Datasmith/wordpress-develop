...
class getid3_id3v1 extends getid3_handler
{
    public function Analyze(): bool
    {
        ...
        if (substr($id3v1tag, 0, 3) == 'TAG') {
            ...
            $GoodFormatID3v1tag = static::GenerateID3v1Tag($ParsedID3v1['title'], $ParsedID3v1['artist'], $ParsedID3v1['album'], $ParsedID3v1['year'], (isset($ParsedID3v1['genre']) ? static::LookupGenreID($ParsedID3v1['genre']) : false), $ParsedID3v1['comment'], (!empty($ParsedID3v1['track_number']) ? $ParsedID3v1['track_number'] : ''));
