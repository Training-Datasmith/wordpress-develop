...
class getid3_lib
{
     ...
     * @param int $num
     */
    public static function intValueSupported($num): bool
    {
     ...
     * @param string $byteword
     */
    public static function BigEndian2Bin($byteword): string
    {
        $binvalue = '';
        $bytewordlen = strlen($byteword);
        for ($i = 0; $i < $bytewordlen; $i++) {
     ...
     * @throws Exception
     */
    public static function BigEndian2String($number, $minbytes = 1, $synchsafe = false, $signed = false): string
    {
        if ($number < 0) {
     ...
     */
    public static function Dec2Bin($number): string
    {
     ...
     */
    public static function FixedPoint8_8($rawdata): float
    {
     ...
     * @param string $rawdata
     */
    public static function FixedPoint16_16($rawdata): float
    {
     ...
     * @param string $rawdata
     */
    public static function FixedPoint2_30($rawdata): float
    {
        ...
        if (function_exists('simplexml_load_string')) {
            if (PHP_VERSION_ID < 80000) {
                ...
                if (defined('LIBXML_VERSION') && (LIBXML_VERSION >= 20900)) {
                    ...
                    libxml_set_external_entity_loader(fn () => null); // https://www.zend.com/blog/cve-2023-3823
                    $allow = true;
                }
                if ($allow) {
                    $XMLobject = simplexml_load_string($XMLstring, 'SimpleXMLElement', GETID3_LIBXML_OPTIONS);
    ...
    */
     ...
     */
    public static function CopyFileParts(string $filename_source, string $filename_dest, $offset, $length): bool
    {
     ...
     * @throws Exception
     */
    public static function iconv_fallback(string $in_charset, string $out_charset, $string)
    {
     ...
     */
    public static function RGADgainString($namecode, $originatorcode, $replaygain): string
    {
        if ($replaygain < 0) {
            $signbit = '1';
        } else {
        ...
        return $gainstring . str_pad(decbin($storedreplaygain), 9, '0', STR_PAD_LEFT);
    }
     ...
     */
    public static function ImageExtFromMime($mime_type): string
    {
     ...
     *
     */
    public static function CopyTagsToComments(array &$ThisFileInfo, $option_tags_html = true): bool
    {
                    ...
                    foreach ($tagdata as $key => $value) {
                        if (!empty($value)) {
                            if (empty($ThisFileInfo['comments'][$tagname])) {
                                ...
                                foreach ($ThisFileInfo['comments'][$tagname] as $existingvalue) {
     ...
     * @throws Exception
     */
    public static function IncludeDependency(string $filename, $sourcefile, $DieOnFailure = false): bool
    {
