...
class getid3_ogg extends getid3_handler
{
     ...
     *
     */
    public function ParseVorbisPageHeader(&$filedata, &$filedataoffset, array &$oggpageinfo): bool
    {
        $info = &$this->getid3->info;
     ...
     */
    public function ParseOpusPageHeader(&$filedata, &$filedataoffset, &$oggpageinfo): bool
    {
        $info = &$this->getid3->info;
     ...
     * @return int
     */
    public static function OggPageSegmentLength(array $OggInfoArray, $SegmentNumber = 1)
    {
        $segmentlength = 0;
