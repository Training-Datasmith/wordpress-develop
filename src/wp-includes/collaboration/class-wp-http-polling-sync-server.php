...
class WP_HTTP_Polling_Sync_Server
{
     ...
     * @var string
     */
    public const REST_NAMESPACE = 'wp-sync/v1';
     ...
     * @var int
     */
    public const AWARENESS_TIMEOUT = 30;
     ...
     * @var int
     */
    public const COMPACTION_THRESHOLD = 50;
     ...
     * @var string
     */
    public const UPDATE_TYPE_COMPACTION = 'compaction';
     ...
     * @var string
     */
    public const UPDATE_TYPE_SYNC_STEP1 = 'sync_step1';
     ...
     * @var string
     */
    public const UPDATE_TYPE_SYNC_STEP2 = 'sync_step2';
     ...
     * @var string
     */
    public const UPDATE_TYPE_UPDATE = 'update';
    ...
    private function can_user_sync_entity_type(string $entity_kind, string $entity_name, ?string $object_id): bool
    {
        ...
        $allowed_collection_entity_kinds = [
            'postType',
            'root',
            'taxonomy',
        ];
