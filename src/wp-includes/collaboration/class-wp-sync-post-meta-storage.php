...
class WP_Sync_Post_Meta_Storage implements WP_Sync_Storage
{
     ...
     * @var string
     */
    public const POST_TYPE = 'wp_sync_storage';
     ...
     * @var string
     */
    public const AWARENESS_META_KEY = 'wp_sync_awareness';
     ...
     * @var string
     */
    public const SYNC_UPDATE_META_KEY = 'wp_sync_update';
     ...
     * @var array<string, int>
     */
    private array $room_update_counts = [];
     ...
     * @var array<string, int>
     */
    private static array $storage_post_ids = [];
