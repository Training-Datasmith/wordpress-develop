...
class Text_Diff_Engine_native
{
    ...
    /**
     * @return \Text_Diff_Op_add[]|\Text_Diff_Op_change[]|\Text_Diff_Op_copy[]|\Text_Diff_Op_delete[]
     */
     ...
     */
    public function _diag($xoff, $xlim, $yoff, $ylim, $nchunks): array
    {
        $flip = false;
