...
final class InputValidator
{
     ...
     */
    public static function is_string_or_stringable($input): bool
    {
     ...
     * @param mixed $input Input parameter to verify.
     */
    public static function is_stringable_object($input): bool
    {
     ...
     * @param mixed $input Input parameter to verify.
     */
    public static function has_array_access($input): bool
    {
     ...
     * @param mixed $input Input parameter to verify.
     */
    public static function is_iterable($input): bool
    {
