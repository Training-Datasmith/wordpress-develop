...
class IdnaEncoder
{
     ...
     */
    public static function encode($hostname): string
    {
     ...
     */
    protected static function is_ascii($text): bool
    {
     ...
     */
    protected static function utf8_to_codepoints($input): array
    {
        $codepoints = [];
     ...
     */
    public static function punycode_encode($input): string
    {
        $output = '';
        // let n = initial_n
     ...
     */
    protected static function digit_to_char($digit): string
    {
        // @codeCoverageIgnoreStart
     ...
     */
    protected static function adapt($delta, $numpoints, $firsttime): float
    {
