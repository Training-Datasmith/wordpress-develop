...
final class Curl implements Transport
{
     ...
     */
    private ?int $response_bytes = null;
     ...
     */
    public function &get_subrequest_handle($url, $headers, $data, array $options)
    {
        $this->setup_handle($url, $headers, $data, $options);
     ...
     * @param array $options Request options, see {@see \WpOrg\Requests\Requests::response()} for documentation
     */
    private function setup_handle($url, $headers, $data, array $options): void
    {
     ...
     */
    public function process_response(string $response, array $options)
    {
     ...
     */
    public function stream_headers($handle, string $headers): int
    {
     ...
     */
    public function stream_body($handle, $data): int
    {
     ...
     */
    private function get_expect_header($data): string
    {
        if (!is_array($data)) {
