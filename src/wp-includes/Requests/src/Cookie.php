...
class Cookie
{
    ...
    protected function normalize_attribute($name, $value)
    {
        switch (strtolower($name)) {
            ...
            case 'max-age':
                ...
                return $this->reference_time + $delta_seconds;
     ...
     * @throws \WpOrg\Requests\Exception\InvalidArgument When the passed $name argument is not a string.
     */
    public static function parse($cookie_header, $name = '', $reference_time = null): self
    {
     ...
     */
    public static function parse_from_headers(Headers $headers, $origin = null, $time = null): array
    {
        ...
        foreach ($cookie_headers as $header) {
            ...
            if (empty($parsed->attributes['domain']) && $origin instanceof \WpOrg\Requests\Iri) {
            ...
            if (!$path_is_valid && $origin instanceof \WpOrg\Requests\Iri) {
                $path = $origin->path;
            ...
            if ($origin instanceof \WpOrg\Requests\Iri && !$parsed->domain_matches($origin->host)) {
                continue;
            }
