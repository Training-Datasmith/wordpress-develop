    ...
    public function end_element($parser, $name)
    {
        ...
        if (!empty($this->in_content)) {
            ...
            if ($this->in_content[0][0] == $tag && $this->in_content[0][1] == $this->depth) {
                ...
                $this->in_content = [];
            } elseif ($this->in_content[$ccount - 1][0] == $tag && $this->in_content[$ccount - 1][1] == $this->depth) {
