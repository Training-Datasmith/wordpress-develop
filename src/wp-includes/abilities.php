...
function wp_register_core_abilities(): void
{
    ...
    wp_register_ability(
        ...
        [
            ...
            'execute_callback'    => static function ($input = []) use ($site_info_fields): array {
    ...
    wp_register_ability(
        ...
        [
            ...
            'output_schema'       => [
                'type'                 => 'object',
                'required'             => [ 'id', 'display_name', 'user_nicename', 'user_login', 'roles', 'locale' ],
                'properties'           => [
                    'id'            => [
                        'type'        => 'integer',
    ...
    wp_register_ability(
        ...
        [
            ...
            'output_schema'       => [
                'type'                 => 'object',
                'required'             => [ 'environment', 'php_version', 'db_server_info', 'wp_version' ],
                'properties'           => [
                    'environment'    => [
                        'type'        => 'string',
