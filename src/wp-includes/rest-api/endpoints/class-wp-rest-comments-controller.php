...
class WP_REST_Comments_Controller extends WP_REST_Controller
{
    ...
    public function get_item_permissions_check($request)
    {
        ...
        $edit_cap = 'note' === $comment->comment_type ? [ 'edit_comment', $comment->comment_ID ] : [ 'moderate_comments' ];
    ...
    public function create_item_permissions_check($request)
    {
        ...
        $edit_cap = $is_note ? [ 'edit_post', (int) $request['post'] ] : [ 'moderate_comments' ];
    ...
    public function create_item($request)
    {
        ...
        if (! empty($request['type']) && ! in_array($request['type'], [ 'comment', 'note' ], true)) {
            return new WP_Error(
    ...
    protected function check_is_comment_content_allowed($prepared_comment)
    {
        ...
        if (
            ...
            in_array($check['meta']['_wp_note_status'], [ 'resolved', 'reopen' ], true)
        ) {
            return true;
        }
