 ...
 */
function maybe_drop_column($table_name, $column_name, $drop_ddl): bool
{
    global $wpdb;
 ...
 */
function check_column($table_name, $col_name, $col_type, $is_null = null, $key = null, $default_value = null, $extra = null): bool
{
    global $wpdb;
