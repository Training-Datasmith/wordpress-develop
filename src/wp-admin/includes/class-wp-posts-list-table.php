...
class WP_Posts_List_Table extends WP_List_Table
{
     ...
     * @since 3.1.0
     */
    private int $sticky_posts_count = 0;

    private ?bool $is_trash = null;
     ...
     */
    protected function get_edit_link($args, $link_text, $css_class = ''): string
    {
     ...
     * @param int   $level
     */
    public function display_rows($posts = [], $level = 0): void
    {
     ...
     */
    private function _page_rows(array &$children_pages, &$count, $parent_page, $level, $pagenum, $per_page, array &$to_display): void
    {
     ...
     */
    protected function _column_title($post, string $classes, $data, $primary)
    {
     ...
     * @param WP_Post $post The current WP_Post object.
     */
    public function column_title($post): void
    {
        global $mode;
     ...
     * @param WP_Post $post The current WP_Post object.
     */
    public function column_date($post): void
    {
        global $mode;
     ...
     * @param WP_Post $post The current WP_Post object.
     */
    public function column_comments($post): void
    {
        ?>
     ...
     * @param WP_Post $post The current WP_Post object.
     */
    public function column_author($post): void
    {
     ...
     * @param int         $level
     */
    public function single_row($post, $level = 0): void
    {
