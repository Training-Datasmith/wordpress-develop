 ...
 */
function _get_list_table($class_name, array $args = [])
{
    $core_classes = [
        // Site Admin.
 ...
 */
function register_column_headers($screen, $columns): void
{
 ...
 */
function print_column_headers($screen, $with_id = true): void
{
