...
function export_wp($args = []): void
{
     ...
     */
    function wxr_cat_name($category): void
    {
     ...
     * @param WP_Term $category Category Object.
     */
    function wxr_category_description($category): void
    {
     ...
     */
    function wxr_tag_name($tag): void
    {
        if (empty($tag->name)) {
            return;
        }
     ...
     * @param WP_Term $tag Tag Object.
     */
    function wxr_tag_description($tag): void
    {
     ...
     */
    function wxr_term_name($term): void
    {
        if (empty($term->name)) {
            return;
        }
     ...
     * @param WP_Term $term Term Object.
     */
    function wxr_term_description($term): void
    {
     ...
     * @param WP_Term $term Term object.
     */
    function wxr_term_meta($term): void
    {
        global $wpdb;
     ...
     */
    function wxr_authors_list(?array $post_ids = null): void
    {
        global $wpdb;
     ...
     * @since 3.1.0
     */
    function wxr_nav_menu_terms(): void
    {
     ...
     * @since 2.3.0
     */
    function wxr_post_taxonomy(): void
    {
        $post = get_post();
