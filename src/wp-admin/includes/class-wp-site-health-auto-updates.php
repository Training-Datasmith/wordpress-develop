...
class WP_Site_Health_Auto_Updates
{
     ...
     */
    public function test_constants($constant, $value): ?array
    {
     ...
     *                    or null if the test passed.
     */
    public function test_wp_version_check_attached(): ?array
    {
     ...
     *                    or null if the test passed.
     */
    public function test_filters_automatic_updater_disabled(): ?array
    {
    ...
    public function test_wp_automatic_updates_disabled()
    {
        ...
        return ['description' => __('All automatic updates are disabled.'), 'severity' => 'fail'];
    }
    /**
    ...
    public function test_if_failed_update()
    {
        ...
        if (!empty($failed['critical'])) {
            ...
            return ['description' => $description, 'severity' => 'warning'];
        }
    ...
    public function test_vcs_abspath(): array
    {
        ...
        return ['description' => __('No version control systems were detected.'), 'severity' => 'pass'];
    }
    /**
    ...
    public function test_check_wp_filesystem_method(): array
    {
        ...
        if (!$success) {
            ...
            return ['description' => $description, 'severity' => 'fail'];
        }
        return ['description' => __('Your installation of WordPress does not require FTP credentials to perform updates.'), 'severity' => 'pass'];
    }
    /**
    ...
    public function test_all_files_writable()
    {
        ...
        if ($unwritable_files) {
            ...
            return ['description' => __('Some files are not writable by WordPress:') . ' <ul><li>' . implode('</li><li>', $unwritable_files) . '</li></ul>', 'severity' => 'fail'];
        }
        return ['description' => __('All of your WordPress files are writable.'), 'severity' => 'pass'];
    }
    /**
     ...
     *                    or null if the test passed.
     */
    public function test_accepts_minor_updates(): ?array
    {
