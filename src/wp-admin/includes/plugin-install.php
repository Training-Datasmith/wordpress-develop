 ...
 * @since 2.7.0
 */
function install_dashboard(): void
{
 ...
 */
function install_search_form($deprecated = true): void
{
 ...
 * @since 2.8.0
 */
function install_plugins_upload(): void
{
    ?>
 ...
 * @since 3.5.0
 */
function install_plugins_favorites_form(): void
{
 ...
 * @global string $tab
 */
function install_plugin_information(): void
{
    global $tab;
 ...
 */
function wp_get_plugin_action_button($name, $data, $compatible_php, $compatible_wp): string
{
    $button           = '';
    $data             = (object) $data;
