 ...
 */
function delete_theme(?string $stylesheet, $redirect = '')
{
 ...
 */
function get_page_templates($post = null, $post_type = 'page'): array
{
 ...
 */
function _get_template_edit_filename($fullpath, $containingfolder): string
{
 ...
 */
function theme_update_available($theme): void
{
 ...
 */
function get_theme_feature_list($api = true): array
{
 ...
 */
function wp_prepare_themes_for_js($themes = null): array
{
 ...
 *                       `WP_Error` on failure.
 */
function resume_theme(string $theme, $redirect = '')
{
 ...
 * @global WP_Paused_Extensions_Storage $_paused_themes
 */
function paused_themes_notice(): void
{
