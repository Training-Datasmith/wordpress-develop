 ...
 */
function _wp_ajax_menu_quick_search(array $request = []): void
{
    $args            = [];
    $type            = $request['type'] ?? '';
 ...
 * @since 3.0.0
 */
function wp_nav_menu_setup(): void
{
    // Register meta boxes.
 ...
 */
function wp_initial_nav_menu_meta_boxes(): void
{
 ...
 * @since 3.0.0
 */
function wp_nav_menu_post_type_meta_boxes(): void
{
 ...
 * @since 3.0.0
 */
function wp_nav_menu_taxonomy_meta_boxes(): void
{
 ...
 */
function wp_nav_menu_item_link_meta_box(): void
{
 ...
 * }
 */
function wp_nav_menu_item_post_type_meta_box($data_object, array $box): void
{
    global $_nav_menu_placeholder, $nav_menu_selected_id;
 ...
 * }
 */
function wp_nav_menu_item_taxonomy_meta_box($data_object, array $box): void
{
 ...
 */
function wp_nav_menu_manage_columns(): array
{
    return [
 ...
 */
function _wp_delete_orphaned_draft_menu_items(): void
{
    global $wpdb;
 ...
 */
function wp_nav_menu_update_menu_items($nav_menu_selected_id, string $nav_menu_selected_title): array
{
 ...
 * @access private
 */
function _wp_expand_nav_menu_post_data(): void
{
