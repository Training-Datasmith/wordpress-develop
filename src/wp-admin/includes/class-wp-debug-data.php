...
class WP_Debug_Data
{
    ...
    public static function debug_data()
    {
        ...
        $info = array_filter(
            $info,
            static fn (?array $section) => isset($section)
        );
        ...
        if (function_exists('opcache_get_status')) {
            ...
            if (false === $opcache_status) {
                ...
                if (true === $opcache_status['opcache_enabled']) {
                    $fields['opcode_cache_memory_usage'] = [
                    ...
                    if (0 !== $opcache_status['interned_strings_usage']['buffer_size']) {
                        $fields['opcode_cache_interned_strings_usage'] = [
    ...
    private static function get_wp_media(): array
    {
        ...
        $fields['image_format_transforms'] = [
    ...
    private static function get_wp_constants(): array
    {
        ...
        $fields = [
            ...
            'EMPTY_TRASH_DAYS'    => [
                ...
                'value' => EMPTY_TRASH_DAYS ?: __('Empty value'),
