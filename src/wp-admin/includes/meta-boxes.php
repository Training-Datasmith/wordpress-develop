 ...
 * }
 */
function post_submit_meta_box($post, array $args = []): void
{
    global $action;
 ...
 * @param WP_Post $post Current post object.
 */
function attachment_submit_meta_box($post): void
{
    ?>
<div class="submitbox" id="submitpost">
 ...
 * }
 */
function post_format_meta_box($post, $box): void
{
 ...
 * }
 */
function post_tags_meta_box($post, array $box): void
{
 ...
 * }
 */
function post_categories_meta_box($post, array $box): void
{
 ...
 * @param WP_Post $post Current post object.
 */
function post_excerpt_meta_box($post): void
{
    ?>
 ...
 * @param WP_Post $post Current post object.
 */
function post_trackback_meta_box($post): void
{
 ...
 * @param WP_Post $post Current post object.
 */
function post_custom_meta_box($post): void
{
    ?>
 ...
 * @param WP_Post $post Current post object.
 */
function post_comment_status_meta_box($post): void
{
    ?>
 ...
 */
function post_comment_meta_box_thead(array $result): array
{
 ...
 * @param WP_Post $post Current post object.
 */
function post_comment_meta_box($post): void
{
 ...
 * @param WP_Post $post Current post object.
 */
function post_slug_meta_box($post): void
{
 ...
 * @param WP_Post $post Current post object.
 */
function post_author_meta_box($post): void
{
    global $user_ID;
 ...
 * @param WP_Post $post Current post object.
 */
function post_revisions_meta_box($post): void
{
 ...
 * @param WP_Post $post Current post object.
 */
function page_attributes_meta_box($post): void
{
 ...
 */
function link_submit_meta_box($link): void
{
    ?>
 ...
 * @param object $link Current link object.
 */
function link_categories_meta_box($link): void
{
    ?>
 ...
 * @param object $link Current link object.
 */
function link_target_meta_box($link): void
{
 ...
 */
function xfn_check($xfn_relationship, $xfn_value = '', $deprecated = ''): void
{
    global $link;
 ...
 * @param object $link Current link object.
 */
function link_xfn_meta_box($link): void
{
    ?>
 ...
 * @param object $link Current link object.
 */
function link_advanced_meta_box($link): void
{
    ?>
 ...
 * @param WP_Post $post Current post object.
 */
function post_thumbnail_meta_box($post): void
{
 ...
 * @param WP_Post $post Current post object.
 */
function attachment_id3_data_meta_box($post): void
{
    $meta = [];
    if (! empty($post->ID)) {
 ...
 */
function register_and_do_post_meta_boxes($post): void
{
    $post_type        = $post->post_type;
    $post_type_object = get_post_type_object($post_type);
