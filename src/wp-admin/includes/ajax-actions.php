 ...
 * @since 3.6.0
 */
function wp_ajax_nopriv_heartbeat(): void
{
    $response = [];
 ...
 * @since 3.1.0
 */
function wp_ajax_fetch_list(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_ajax_tag_search(): void
{
    if (! isset($_GET['tax'])) {
        wp_die(0);
    }
 ...
 * @since 3.1.0
 */
function wp_ajax_wp_compression_test(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_imgedit_preview(): void
{
 ...
 */
function wp_ajax_oembed_cache(): void
{
 ...
 * @since 3.4.0
 */
function wp_ajax_autocomplete_user(): void
{
 ...
 * @since 4.8.0
 */
function wp_ajax_get_community_events(): void
{
 ...
 * @since 3.4.0
 */
function wp_ajax_dashboard_widgets(): void
{
 ...
 * @since 3.4.0
 */
function wp_ajax_logged_in(): void
{
    wp_die(1);
}
 ...
 */
function _wp_ajax_delete_comment_response($comment_id, $delta = -1): void
{
 ...
 * @access private
 */
function _wp_ajax_add_hierarchical_term(): void
{
    $action   = $_POST['action'];
    ...
    foreach ($names as $category_name) {
        ...
        $category_id = wp_insert_term($category_name, $taxonomy->name, [ 'parent' => $parent ]);
        if (! $category_id) {
            continue;
        }
    ...
    $add['supplemental'] = [ 'newcat_parent' => $supplemental ];
 ...
 * @since 3.1.0
 */
function wp_ajax_delete_comment(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_delete_tag(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_delete_link(): void
{
    $id = isset($_POST['id']) ? (int) $_POST['id'] : 0;
 ...
 * @since 3.1.0
 */
function wp_ajax_delete_meta(): void
{
    $id = isset($_POST['id']) ? (int) $_POST['id'] : 0;
 ...
 */
function wp_ajax_delete_post($action): void
{
    if (empty($action)) {
        $action = 'delete-post';
    }
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_trash_post($action): void
{
    if (empty($action)) {
        $action = 'trash-post';
    }
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_untrash_post($action): void
{
    if (empty($action)) {
        $action = 'untrash-post';
    }
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_delete_page($action): void
{
    if (empty($action)) {
        $action = 'delete-page';
    }
 ...
 * @since 3.1.0
 */
function wp_ajax_dim_comment(): void
{
    $id      = isset($_POST['id']) ? (int) $_POST['id'] : 0;
    $comment = get_comment($id);
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_add_link_category($action): void
{
    if (empty($action)) {
 ...
 * @since 3.1.0
 */
function wp_ajax_get_tagcloud(): void
{
    if (! isset($_POST['tax'])) {
        wp_die(0);
    }
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_get_comments($action): void
{
    global $post_id;
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_replyto_comment($action): void
{
    if (empty($action)) {
 ...
 * @since 3.1.0
 */
function wp_ajax_edit_comment(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_add_menu_item(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_add_meta(): void
{
 ...
 * @param string $action Action to perform.
 */
function wp_ajax_add_user($action): void
{
    if (empty($action)) {
        $action = 'add-user';
    }
 ...
 * @since 3.1.0
 */
function wp_ajax_closed_postboxes(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_hidden_columns(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_update_welcome_panel(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_menu_get_metabox(): void
{
    if (! current_user_can('edit_theme_options')) {
        wp_die(-1);
    }
 ...
 * @since 3.1.0
 */
function wp_ajax_wp_link_ajax(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_menu_locations_save(): void
{
    if (! current_user_can('edit_theme_options')) {
        wp_die(-1);
    }
 ...
 * @since 3.1.0
 */
function wp_ajax_meta_box_order(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_menu_quick_search(): void
{
    if (! current_user_can('edit_theme_options')) {
        wp_die(-1);
    }
 ...
 * @since 3.1.0
 */
function wp_ajax_get_permalink(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_sample_permalink(): void
{
 ...
 */
function wp_ajax_inline_save(): void
{
    global $mode;
 ...
 * @since 3.1.0
 */
function wp_ajax_inline_save_tax(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_find_posts(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_widgets_order(): void
{
 ...
 */
function wp_ajax_save_widget(): void
{
 ...
 */
function wp_ajax_update_widget(): void
{
    global $wp_customize;
 ...
 * @since 4.4.0
 */
function wp_ajax_delete_inactive_widgets(): void
{
 ...
 * @since 5.3.0
 */
function wp_ajax_media_create_image_subsizes(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_image_editor(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_set_post_thumbnail(): void
{
 ...
 * @since 4.6.0
 */
function wp_ajax_get_post_thumbnail_html(): void
{
    $post_id = (int) $_POST['post_id'];
 ...
 */
function wp_ajax_set_attachment_thumbnail(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_date_format(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_time_format(): void
{
 ...
 * @deprecated 4.3.0
 */
function wp_ajax_wp_fullscreen_save_post(): void
{
    $post_id = isset($_POST['post_ID']) ? (int) $_POST['post_ID'] : 0;
 ...
 * @since 3.1.0
 */
function wp_ajax_wp_remove_post_lock(): void
{
 ...
 * @since 3.1.0
 */
function wp_ajax_dismiss_wp_pointer(): void
{
 ...
 * @since 3.5.0
 */
function wp_ajax_get_attachment(): void
{
 ...
 * @since 3.5.0
 */
function wp_ajax_query_attachments(): void
{
    if (! current_user_can('upload_files')) {
        wp_send_json_error();
    }
 ...
 * @since 3.5.0
 */
function wp_ajax_save_attachment(): void
{
 ...
 * @since 3.5.0
 */
function wp_ajax_save_attachment_compat(): void
{
    if (! isset($_REQUEST['id'])) {
        wp_send_json_error();
    }
 ...
 * @since 3.5.0
 */
function wp_ajax_save_attachment_order(): void
{
    if (! isset($_REQUEST['post_id'])) {
        wp_send_json_error();
    }
 ...
 * @since 3.5.0
 */
function wp_ajax_send_attachment_to_editor(): void
{
 ...
 * @global WP_Embed $wp_embed WordPress Embed object.
 */
function wp_ajax_send_link_to_editor(): void
{
 ...
 * @since 3.6.0
 */
function wp_ajax_heartbeat(): void
{
 ...
 * @since 3.6.0
 */
function wp_ajax_get_revision_diffs(): void
{
 ...
 */
function wp_ajax_save_user_color_scheme(): void
{
 ...
 */
function wp_ajax_query_themes(): void
{
 ...
 */
function wp_ajax_parse_embed(): void
{
 ...
 * @global WP_Scripts $wp_scripts Script dependencies object.
 */
function wp_ajax_parse_media_shortcode(): void
{
 ...
 * @since 4.1.0
 */
function wp_ajax_destroy_sessions(): void
{
 ...
 * @since 4.3.0
 */
function wp_ajax_crop_image(): void
{
 ...
 * @since 4.4.0
 */
function wp_ajax_generate_password(): void
{
 ...
 * @since 5.7.0
 */
function wp_ajax_nopriv_generate_password(): void
{
    wp_send_json_success(wp_generate_password(24));
}
 ...
 * @since 4.4.0
 */
function wp_ajax_save_wporg_username(): void
{
 ...
 */
function wp_ajax_install_theme(): void
{
 ...
 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
 */
function wp_ajax_update_theme(): void
{
    check_ajax_referer('updates');
 ...
 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
 */
function wp_ajax_delete_theme(): void
{
    check_ajax_referer('updates');
 ...
 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
 */
function wp_ajax_install_plugin(): void
{
    check_ajax_referer('updates');
 ...
 * @since 6.5.0
 */
function wp_ajax_activate_plugin(): void
{
    check_ajax_referer('updates');
 ...
 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
 */
function wp_ajax_update_plugin(): void
{
    check_ajax_referer('updates');
 ...
 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
 */
function wp_ajax_delete_plugin(): void
{
    check_ajax_referer('updates');
 ...
 */
function wp_ajax_search_plugins(): void
{
    check_ajax_referer('updates');
 ...
 * @since 4.6.0
 */
function wp_ajax_search_install_plugins(): void
{
    check_ajax_referer('updates');
 ...
 */
function wp_ajax_edit_theme_plugin_file(): void
{
 ...
 * @since 4.9.6
 */
function wp_ajax_wp_privacy_export_personal_data(): void
{
 ...
 * @since 4.9.6
 */
function wp_ajax_wp_privacy_erase_personal_data(): void
{
 ...
 */
function wp_ajax_health_check_dotorg_communication(): void
{
    _doing_it_wrong(
 ...
 */
function wp_ajax_health_check_background_updates(): void
{
    _doing_it_wrong(
 ...
 */
function wp_ajax_health_check_loopback_requests(): void
{
    _doing_it_wrong(
 ...
 * @since 5.2.0
 */
function wp_ajax_health_check_site_status_result(): void
{
 ...
 */
function wp_ajax_health_check_get_sizes(): void
{
    _doing_it_wrong(
 ...
 * @since 5.3.0
 */
function wp_ajax_rest_nonce(): void
{
 ...
 * @since 5.5.0
 */
function wp_ajax_toggle_auto_updates(): void
{
    check_ajax_referer('updates');
 ...
 * @since 5.7.0
 */
function wp_ajax_send_password_reset(): void
{
