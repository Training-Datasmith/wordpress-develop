...
class WP_MS_Sites_List_Table extends WP_List_Table
{
    ...
    public function __construct($args = [])
    {
        $this->status_list = [
            ...
            'deleted'  => [ 'site-deleted', __('Flagged for Deletion') ],
     ...
     */
    public function column_id(array $blog): void
    {
        echo $blog['blog_id'];
    }
     ...
     * @param array $blog Current site.
     */
    public function column_blogname(array $blog): void
    {
        global $mode;
     ...
     * @param array $blog Current site.
     */
    public function column_lastupdated(array $blog): void
    {
        global $mode;
     ...
     * @param array $blog Current site.
     */
    public function column_registered(array $blog): void
    {
        global $mode;
     ...
     * @param array $blog Current site.
     */
    public function column_users(array $blog): void
    {
     ...
     * @param array $blog Current site.
     */
    public function column_plugins(array $blog): void
    {
        if (has_filter('wpmublogsaction')) {
            /**
     ...
     */
    protected function site_states(array $site)
    {
        $site_states = [];
