...
class WP_Themes_List_Table extends WP_List_Table
{
     ...
     * @param string $which
     */
    public function tablenav($which = 'top'): void
    {
    ...
    public function search_theme($theme): bool
    {
        ...
        foreach ($this->search_terms as $word) {
            ...
            foreach ([ 'Name', 'Description', 'Author', 'AuthorURI' ] as $header) {
                ...
                if (false !== stripos(strip_tags($theme->display($header, false, true)), (string) $word)) {
                    continue 2;
                }
            }

            if (false !== stripos($theme->get_stylesheet(), (string) $word)) {
                continue;
            }

            if (false !== stripos($theme->get_template(), (string) $word)) {
                continue;
            }
     ...
     */
    public function _js_vars($extra_args = []): void
    {
