...
class WP_MS_Users_List_Table extends WP_List_Table
{
     ...
     */
    public function column_id($user): void
    {
        echo $user->ID;
    }
     ...
     * @param WP_User $user The current WP_User object.
     */
    public function column_username($user): void
    {
        $super_admins = get_super_admins();
     ...
     * @param WP_User $user The current WP_User object.
     */
    public function column_name($user): void
    {
     ...
     * @param WP_User $user The current WP_User object.
     */
    public function column_email($user): void
    {
     ...
     * @param WP_User $user The current WP_User object.
     */
    public function column_registered($user): void
    {
        global $mode;
        if ('list' === $mode) {
            $date = __('Y/m/d');
     ...
     * @param WP_User $user The current WP_User object.
     */
    public function column_blogs($user): void
    {
