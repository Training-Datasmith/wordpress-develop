 ...
 * @param string $to Path to old WordPress installation.
 */
function _preload_old_requests_classes_and_interfaces(string $to): void
{
 ...
 */
function _redirect_to_about_wordpress($new_version): void
{
 ...
 */
function _upgrade_422_remove_genericons(): void
{
 ...
 * @return string[]
 */
function _upgrade_422_find_genericons_files_in_folder($directory): array
{
    ...
    $dirs = array_filter(
         ...
         * the polyfills from wp-includes/compat.php may not be available.
         */
        static fn ($dir) => false === strpos($dir, 'node_modules')
    );
 ...
 * @since 4.4.0
 */
function _upgrade_440_force_deactivate_incompatible_plugins(): void
{
 ...
 */
function _upgrade_core_deactivate_incompatible_plugins(): void
{
