 ...
 * @return bool True if the option was updated, false otherwise.
 */
function undismiss_core_update(string $version, string $locale)
{
    $dismissed = get_site_option('dismissed_update_core');
    $key       = $version . '|' . $locale;
 ...
 */
function core_update_footer($msg = ''): string
{
 ...
 * @since 2.5.0
 */
function update_right_now_message(): void
{
 ...
 * @since 2.9.0
 */
function wp_plugin_update_rows(): void
{
 ...
 */
function wp_plugin_update_row(string $file, array $plugin_data)
{
    $current = get_site_transient('update_plugins');
 ...
 * @since 3.1.0
 */
function wp_theme_update_rows(): void
{
 ...
 */
function wp_theme_update_row(string $theme_key, $theme)
{
    $current = get_site_transient('update_themes');
 ...
 *     }
 */
function wp_print_admin_notice_templates(): void
{
    ?>
 ...
 *     }
 */
function wp_print_update_row_templates(): void
{
    ?>
 ...
 * @since 5.2.0
 */
function wp_recovery_mode_nag(): void
{
