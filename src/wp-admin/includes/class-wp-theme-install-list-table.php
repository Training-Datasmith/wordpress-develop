...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table
{
     ...
     */
    public function theme_installer(): void
    {
        ?>
     ...
     */
    public function theme_installer_single($theme): void
    {
        ?>
     ...
     * @param stdClass $theme A WordPress.org Theme API object.
     */
    public function install_theme_info($theme): void
    {
        global $themes_allowedtags;
     ...
     */
    private function _get_theme_status($theme): string
    {
        $status = 'install';
