 ...
 */
function _sort_name_callback(array $a, array $b): int
{
 ...
 */
function wp_list_widget_controls($sidebar, $sidebar_name = ''): void
{
 ...
 */
function wp_list_widget_controls_dynamic_sidebar(array $params): array
{
 ...
 */
function wp_widget_control(array $sidebar_args): array
{
