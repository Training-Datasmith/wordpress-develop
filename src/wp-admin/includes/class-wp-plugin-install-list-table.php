...
class WP_Plugin_Install_List_Table extends WP_List_Table
{
     ...
     * @since 4.0.0
     */
    protected function get_installed_plugin_slugs(): array
    {
...
<div class="wp-list-table <?php echo implode(' ', $this->get_table_classes()); ?>">
     ...
     */
    private function order_callback($plugin_a, $plugin_b): int
    {
     ...
     */
    protected function get_dependencies_notice(array $plugin_data): string
    {
     ...
     */
    protected function get_more_details_link($name, $slug): string
    {
        $url = add_query_arg(
            [
