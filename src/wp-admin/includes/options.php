 ...
 * @since 4.2.0
 */
function options_discussion_add_js(): void
{
    ?>
	<script>
	(function($){
 ...
 * @since 3.5.0
 */
function options_general_add_js(): void
{
    ?>
<script>
	jQuery( function($) {
 ...
 * @since 3.5.0
 */
function options_reading_add_js(): void
{
    ?>
<script>
	jQuery( function($) {
 ...
 * @since 3.5.0
 */
function options_reading_blog_charset(): void
{
