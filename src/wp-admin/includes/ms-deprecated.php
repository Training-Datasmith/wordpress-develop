 ...
 */
function wpmu_check_available_space(): void
{
 ...
 * @see activate_plugin()
 */
function activate_sitewide_plugin(): bool
{
 ...
 */
function deactivate_sitewide_plugin($plugin = false): void
{
 ...
 */
function get_site_allowed_themes(): array
{
 ...
 */
function wpmu_get_blog_allowedthemes($blog_id = 0): array
{
 ...
 * @deprecated 3.5.0
 */
function ms_deprecated_blogs_file(): void
{
}
if (!function_exists('install_global_terms')) {
     ...
     * @deprecated 6.1.0
     */
    function install_global_terms(): void
    {
