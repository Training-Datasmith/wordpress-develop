 ...
 */
function get_default_link_to_edit(): \stdClass
{
    $link = new stdClass();
 ...
 */
function wp_delete_link($link_id): bool
{
    global $wpdb;
    /**
 ...
 */
function wp_get_link_cats($link_id = 0): array
{
 ...
 */
function wp_set_link_cats($link_id = 0, $link_categories = []): void
{
 ...
 */
function wp_link_manager_disabled_message(): void
{
    global $pagenow;
