 ...
 * @param int $id User ID.
 */
function wp_revoke_user($id): void
{
    $id = (int) $id;
 ...
 */
function default_password_nag_edit_user($user_ID, $old_data): void
{
    // Short-circuit it.
 ...
 */
function use_ssl_preference($user): void
{
    ?>
 ...
 */
function admin_created_user_email($text): string
{
 ...
 */
function wp_is_authorize_application_password_request_valid(array $request, $user)
{
    $error = new WP_Error();
