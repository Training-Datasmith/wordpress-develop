 ...
 */
function install_theme_search_form($type_selector = true): void
{
 ...
 * @since 2.8.0
 */
function install_themes_dashboard(): void
{
 ...
 * @since 2.8.0
 */
function install_themes_upload(): void
{
    ?>
 ...
 * @param object $theme
 */
function display_theme($theme): void
{
 ...
 * @global WP_Theme_Install_List_Table $wp_list_table
 */
function install_theme_information(): void
{
    global $wp_list_table;
