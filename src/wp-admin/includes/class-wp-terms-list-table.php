...
class WP_Terms_List_Table extends WP_List_Table
{
     ...
     * @param int    $level
     */
    private function _rows($taxonomy, array $terms, array &$children, $start, $per_page, &$count, $parent_term = 0, $level = 0): void
    {
     ...
     * @param int     $level
     */
    public function single_row($tag, $level = 0): void
    {
        global $taxonomy;
     ...
     * @param WP_Term $tag Term object.
     */
    public function column_name($tag): string
    {
        $taxonomy = $this->screen->taxonomy;
