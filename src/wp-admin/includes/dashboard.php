 ...
 */
function wp_add_dashboard_widget($widget_id, string $widget_name, $callback, $control_callback = null, $callback_args = null, $context = 'normal', $priority = 'core'): void
{
 ...
 */
function _wp_dashboard_control_callback($dashboard, array $meta_box): void
{
 ...
 * @since 2.7.0
 */
function wp_dashboard_right_now(): void
{
    ?>
	<div class="main">
	<ul>
 ...
 * @since 3.1.0
 */
function wp_network_dashboard_right_now(): void
{
    $actions = [];
 ...
 */
function wp_dashboard_quick_press($error_msg = false): void
{
    global $post_ID;
 ...
 */
function wp_dashboard_recent_drafts($drafts = false): void
{
    if (! $drafts) {
        $query_args = [
            'post_type'      => 'post',
 ...
 */
function _wp_dashboard_recent_comments_row(&$comment, $show_date = true): void
{
 ...
 * @since 3.8.0
 */
function wp_dashboard_site_activity(): void
{
 ...
 */
function wp_dashboard_recent_posts(array $args): bool
{
    $query_args = [
        'post_type'      => 'post',
 ...
 */
function wp_dashboard_recent_comments($total_items = 5): bool
{
 ...
 */
function wp_dashboard_rss_output($widget_id): void
{
 ...
 */
function wp_dashboard_cached_rss_widget(string $widget_id, $callback, $check_urls = [], ...$args): bool
{
 ...
 */
function wp_dashboard_trigger_widget_control($widget_control_id = false): void
{
    global $wp_dashboard_control_callbacks;
 ...
 */
function wp_dashboard_rss_control(string $widget_id, $form_inputs = []): void
{
 ...
 * @since 4.8.0
 */
function wp_dashboard_events_news(): void
{
 ...
 * @since 4.8.0
 */
function wp_print_community_events_markup(): void
{
 ...
 * @since 4.8.0
 */
function wp_print_community_events_templates(): void
{
    ?>
 ...
 */
function wp_dashboard_primary(): void
{
    $feeds = [
        'news'   => [
 ...
 */
function wp_dashboard_primary_output($widget_id, $feeds): void
{
 ...
 * @global bool $is_IE
 */
function wp_dashboard_browser_nag(): void
{
    global $is_IE;
 ...
 * @since 5.1.0
 */
function wp_dashboard_php_nag(): void
{
 ...
 * @since 5.4.0
 */
function wp_dashboard_site_health(): void
{
 ...
 * @since 2.5.0
 */
function wp_dashboard_empty(): void
{
}
 ...
 */
function wp_welcome_panel(): void
{
