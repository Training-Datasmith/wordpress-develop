 ...
 */
function _wp_credits_add_profile_link(&$display_name, $username, $profiles): void
{
 ...
 */
function wp_credits_section_title(array $group_data = []): void
{
    if (! count($group_data)) {
        return;
    }
 ...
 */
function wp_credits_section_list(array $credits = [], string $slug = ''): void
{
    $group_data   = $credits['groups'][ $slug ] ?? [];
