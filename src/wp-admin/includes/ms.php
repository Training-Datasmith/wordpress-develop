 ...
 */
function check_upload_size(array $file): array
{
 ...
 */
function wpmu_delete_blog($blog_id, $drop = false): void
{
    $blog_id = (int) $blog_id;
 ...
 */
function wpmu_delete_user($id): bool
{
    global $wpdb;
 ...
 */
function upload_is_user_over_quota($display_message = true): bool
{
    if (get_site_option('upload_space_check_disabled')) {
        return false;
    }
 ...
 */
function fix_import_form_size($size): int
{
    if (upload_is_user_over_quota(false)) {
        return 0;
    }
 ...
 */
function upload_space_setting($id): void
{
    switch_to_blog($id);
 ...
 */
function format_code_lang($code = ''): string
{
 ...
 * @access private
 */
function _access_denied_splash(): void
{
 ...
 */
function check_import_new_users($permission): bool
{
 ...
 */
function mu_dropdown_languages($lang_files = [], $current = ''): void
{
    $flag   = false;
    $output = [];
 ...
 */
function avoid_blog_page_permalink_collision(array $data, $postarr)
{
 ...
 * @access private
 */
function _thickbox_path_admin_subfolder(): void
{
    ?>
<script>
 ...
 * @param array $users
 */
function confirm_delete_users($users): bool
{
 ...
 * @since 4.1.0
 */
function network_settings_add_js(): void
{
    ?>
<script>
jQuery( function($) {
 ...
 * }
 */
function network_edit_site_nav($args = []): void
{
 ...
 */
function get_site_screen_help_tab_args(): array
{
    return [
        'id'      => 'overview',
        'title'   => __('Overview'),
 ...
 */
function get_site_screen_help_sidebar_content(): string
{
 ...
 */
function wp_ensure_editable_role($role): void
{
