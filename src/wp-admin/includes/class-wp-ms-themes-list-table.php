...
class WP_MS_Themes_List_Table extends WP_List_Table
{
     ...
     */
    protected bool $show_autoupdates;
    ...
    public function _search_callback($theme): bool
    {
        ...
        foreach ([ 'Name', 'Description', 'Author', 'Author', 'AuthorURI' ] as $field) {
            ...
            if (false !== stripos($theme->display($field, false, true), (string) $term)) {
                return true;
            }
        }

        if (false !== stripos($theme->get_stylesheet(), (string) $term)) {
            return true;
        }

        if (false !== stripos($theme->get_template(), (string) $term)) {
            return true;
        }
     ...
     */
    public function column_name($theme): void
    {
     ...
     * @param WP_Theme $theme The current WP_Theme object.
     */
    public function column_description($theme): void
    {
     ...
     * @param WP_Theme $theme The current WP_Theme object.
     */
    public function column_autoupdates($theme): void
    {
        global $status, $page;
