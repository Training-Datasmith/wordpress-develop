 ...
 */
function _get_plugin_data_markup_translate($plugin_file, array $plugin_data, $markup = true, $translate = true): array
{
 ...
 */
function get_plugin_files(string $plugin): array
{
 ...
 */
function get_plugins(?string $plugin_folder = '')
{
 ...
 */
function _sort_uname_callback(array $a, array $b): int
{
 ...
 */
function is_plugin_inactive($plugin): bool
{
 ...
 */
function is_network_only_plugin(string $plugin)
{
 ...
 */
function activate_plugin($plugin, $redirect = '', $network_wide = false, $silent = false): ?\WP_Error
{
 ...
 */
function deactivate_plugins($plugins, $silent = false, $network_wide = null): void
{
    if (is_multisite()) {
 ...
 */
function validate_active_plugins(): array
{
 ...
 */
function validate_plugin(string $plugin)
{
 ...
 */
function validate_plugin_requirements(string $plugin)
{
 ...
 */
function is_uninstallable_plugin($plugin): bool
{
 ...
 */
function add_menu_page($page_title, string $menu_title, $capability, $menu_slug, $callback = '', $icon_url = '', $position = null)
{
 ...
 */
function menu_page_url(string $menu_slug, $display = true)
{
...
function option_update_filter($options)
{
    ...
    if (is_array($new_allowed_options)) {
        return add_allowed_options($new_allowed_options, $options);
    }
 ...
 * @param string $plugin Path to the plugin file relative to the plugins directory.
 */
function plugin_sandbox_scrape(string $plugin): void
{
 ...
 */
function wp_add_privacy_policy_content($plugin_name, $policy_text): void
{
    if (! is_admin()) {
        _doing_it_wrong(
            __FUNCTION__,
 ...
 *                       `WP_Error` on failure.
 */
function resume_plugin(string $plugin, $redirect = '')
{
    /*
 ...
 * @global WP_Paused_Extensions_Storage $_paused_plugins
 */
function paused_plugins_notice(): void
{
