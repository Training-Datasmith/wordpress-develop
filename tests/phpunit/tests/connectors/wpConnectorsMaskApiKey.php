...
class Tests_Connectors_WpConnectorsMaskApiKey extends WP_UnitTestCase
{
    ...
    public function data_mask_api_key(): array
    {
        ...
        return [
            'empty string'                 => [ '', '' ],
            '1 char'                       => [ 'a', 'a' ],
            '4 chars (boundary)'           => [ 'abcd', 'abcd' ],
            '5 chars (1 bullet + last 4)'  => [ 'abcde', $bullet . 'bcde' ],
            '20 chars (cap at 16 bullets)' => [ '12345678901234567890', str_repeat($bullet, 16) . '7890' ],
            '30 chars (cap at 16 bullets)' => [ str_repeat('x', 30), str_repeat($bullet, 16) . 'xxxx' ],
        ];
    }
}
