...
class Tests_Connectors_WpConnectorsGetConnectorSettings extends WP_UnitTestCase
{
    ...
    public function test_each_connector_has_required_fields()
    {
        ...
        foreach ($connectors as $connector_id => $connector_data) {
            ...
            $this->assertContains($connector_data['type'], [ 'ai_provider' ], "Connector '{$connector_id}' has unexpected type '{$connector_data['type']}'.");
            ...
            $this->assertContains($connector_data['authentication']['method'], [ 'api_key', 'none' ], "Connector '{$connector_id}' has unexpected authentication method.");
        }
    }
