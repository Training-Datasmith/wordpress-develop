...
JS;
    ...
    public function test_wp_enqueue_script()
    {
        ...
        wp_enqueue_script('empty-deps-arg-in-handle-with-ver?arg1=foo&arg2=bar', 'https://example.com/test.js', [], '2.0');
        wp_enqueue_script('empty-deps-arg-in-handle-without-ver?arg1=foo&arg2=bar', 'https://example.com/test.js', [], null);
...
HTML
    ...
    public function test_defer_with_async_dependent()
    {
        ...
        wp_register_script('main-script-d4', '/main-script-d4.js', [], null, [ 'strategy' => 'defer' ]);
        wp_enqueue_script(
    ...
    {
        wp_register_script('test-script', '/test-script.js', [], null, [ 'fetchpriority' => $fetchpriority ]);
    ...
    {
        wp_register_script('unset', '/joke.js', [], null, [ 'fetchpriority' => 'low' ]);
    ...
    {
        wp_register_script('joke', '/joke.js', [], null, [ 'fetchpriority' => 'silly' ]);
    ...
    public function test_invalid_fetchpriority_value_type()
    {
        ...
        $this->assertFalse(wp_script_add_data('bad', 'fetchpriority', [ 'THIS IS SO WRONG!!!' ]));
    ...
    {
        wp_register_script('alias', false, [], null, [ 'fetchpriority' => 'low' ]);
    ...
    {
        wp_register_script('bajo', '/bajo.js', [], null, [ 'fetchpriority' => 'low' ]);
        wp_register_script('auto', '/auto.js', [ 'bajo' ], null, [ 'fetchpriority' => 'auto' ]);
        wp_register_script('alto', '/alto.js', [ 'auto' ], null, [ 'fetchpriority' => 'high' ]);
    ...
    {
        wp_register_script('a', '/a.js', [ 'b' ], null, [ 'fetchpriority' => 'low' ]);
        wp_register_script('b', '/b.js', [ 'c' ], null, [ 'fetchpriority' => 'auto' ]);
        wp_register_script('c', '/c.js', [ 'd', 'e' ], null, [ 'fetchpriority' => 'auto' ]);
        wp_register_script('d', '/d.js', [ 'z' ], null, [ 'fetchpriority' => 'high' ]);
        wp_register_script('e', '/e.js', [], null, [ 'fetchpriority' => 'auto' ]);

        wp_register_script('x', '/x.js', [ 'd', 'y' ], null, [ 'fetchpriority' => 'high' ]);
        wp_register_script('y', '/y.js', [ 'z' ], null, [ 'fetchpriority' => 'auto' ]);
        wp_register_script('z', '/z.js', [], null, [ 'fetchpriority' => 'auto' ]);
...
HTML;
    ...
    public function test_highest_fetchpriority_with_dependents_uses_cached_result()
    {
        ...
        $result = $method->invokeArgs($wp_scripts, [ 'd', [], &$stored_results ]);
    ...
    public function test_priority_of_dependency_for_non_enqueued_dependent()
    {
        ...
        $wp_scripts->add('not-enqueued', 'https://example.com/not-enqueued.js', [ 'comment-reply' ], null, [ 'priority' => 'high' ]);
        $wp_scripts->enqueue('comment-reply');

        $actual = $this->normalize_markup_for_snapshot(get_echo([ $wp_scripts, 'print_scripts' ]));
    ...
    public function test_printing_default_script_comment_reply_enqueued_or_not_enqueued(bool $enqueue)
    {
        ...
        if ($enqueue) {
            ...
            $markup = get_echo([ $wp_scripts, 'do_items' ], [ false ]);
        } else {
            $markup = get_echo([ $wp_scripts, 'do_items' ], [ [ 'comment-reply' ] ]);
        }
    ...
    public function test_filter_eligible_strategies_uses_cached_result()
    {
        ...
        $result = $method->invokeArgs($wp_scripts, [ 'd', null, [], &$stored_results ]);
...
HTML;
    ...
    public function test_wp_set_script_translations_uses_registered_domainpath_for_plugin()
    {
        ...
        wp_register_script('wp-i18n', '/wp-includes/js/dist/wp-i18n.js', [], null);
        wp_enqueue_script('domain-path-plugin', '/wp-content/plugins/my-plugin/js/script.js', [], null);
    ...
    public function data_vendor_script_versions_registered_manually()
    {
        return [
            'backbone'                         => [ 'backbone' ],
            'clipboard'                        => [ 'clipboard' ],
            'codemirror'                       => [ 'codemirror', 'wp-codemirror' ],
    ...
    public function test_vendor_script_data_provider_includes_all_packages()
    {
        ...
        $exclude                   = [ 'react-is', 'json2php', 'espree' ];
...
HTML;
    ...
    public function test_source_url_with_concat()
    {
        ...
        wp_localize_script('one', 'one', [ 'key' => 'val' ]);
        wp_localize_script('two', 'two', [ 'key' => 'val' ]);
...
HTML;
    ...
    public function test_wp_scripts_doing_it_wrong_for_missing_dependencies()
    {
        ...
        wp_enqueue_script('main', '/main.js', [ 'registered-dep', 'missing-dep' ]);
    ...
    {
        wp_enqueue_script('test-script?qs1=q1&qs2=q2', '/test-script.js', [], $version);
        $markup = get_echo('wp_print_scripts');
    ...
    {
        wp_register_script('test-script', '/test-script.js', [], $version);
