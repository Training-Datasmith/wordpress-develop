...
class Tests_Dependencies_Styles extends WP_UnitTestCase
{
    ...
    public function test_wp_enqueue_style()
    {
        ...
        wp_enqueue_style('no-deps-arg-in-handle-with-ver?arg1=foo&arg2=bar', 'https://example.com/test.css', [], '2.0');
        wp_enqueue_style('no-deps-arg-in-handle-without-ver?arg1=foo&arg2=bar', 'https://example.com/test.css', [], null);
    ...
    {
        wp_enqueue_style($handle, 'example.com', [], null);
    ...
    {
        return [
            'some spaces'       => [ 'with some spaces' ],
            'snowman'           => [ 'with-☃-snowman' ],
            'trailing space'    => [ 'with-trailing-space ' ],
            'leading space'     => [ ' with-leading-space' ],
            'an "ironic" title' => [ 'an &quot;ironic&quot; title' ],
        ];
    }
    ...
    public function test_wp_maybe_inline_styles(?string $additional_inline_style, ?int $styles_inline_size_limit)
    {
        ...
        wp_register_style($handle, $src_url, [], null);
        ...
        $printed_styles = get_echo('wp_print_styles', [ $handle ]);
    ...
    {
        return [
            'regular_limit_without_additional_inline_styles' => [
                'additional_inline_style'  => null,
                'styles_inline_size_limit' => null,
            ],
            'regular_limit_with_additional_inline_style' => [
                'additional_inline_style'  => '/* additional inline style */',
                'styles_inline_size_limit' => null,
            ],
            'zero_limit_without_additional_inline_style' => [
                'additional_inline_style'  => null,
                'styles_inline_size_limit' => 0,
            ],
            'zero_limit_with_additional_inline_style'    => [
                'additional_inline_style'  => '/* additional inline style */',
                'styles_inline_size_limit' => 0,
            ],
        ];
    ...
    {
        $handle = '# test/</style> #';
        wp_enqueue_style($handle, '/example.css', [], '0.0');
...
HTML;
    ...
    public function test_source_url_with_concat()
    {
        ...
        $wp_styles->do_concat    = true;
        $wp_styles->default_dirs = [ '/wp-admin/' ];
...
HTML;
    ...
    {
        wp_enqueue_style('test-style?qs1=q1&qs2=q2', '/test-style.css', [], $version);
        $markup = get_echo('wp_print_styles');
    ...
    {
        wp_register_style('test-style', '/test-style.css', [], $version);
