...
class Tests_Meta extends WP_UnitTestCase
{
    ...
    {
        self::$author         = new WP_User($factory->user->create([ 'role' => 'author' ]));
    ...
    public function test_update_metadata_by_mid()
    {
        ...
        $this->assertTrue(update_metadata_by_mid('user', self::$meta_id, [ 'first', 'second' ]));
        $meta = get_metadata_by_mid('user', self::$meta_id);
        ...
        $this->assertFalse(update_metadata_by_mid('user', self::$meta_id, 'meta_value', [ 'invalid', 'key' ]));
    ...
    public function test_string_point_zero_meta_id()
    {
        ...
        $this->assertTrue(floor((float) $string_mid) == $string_mid);
