...
CSS;
    ...
    public static function data_custom_css_allowed(): array
    {
        return [
            ...
            'Different close tag'     => [ '</stylesheet>' ],
            'Not a style close tag'   => [ '/*</style*/' ],
            'Not a style close tag 2' => [ '/*</style_' ],
            'Empty'                   => [ '' ],
            'Short content'           => [ '/**/' ],
        ];
    }
    ...
    {
        return [
            'style close tag'            => [ 'css…</style>…css', 'The CSS must not contain "&lt;/style&gt;".' ],
            'style close tag upper case' => [ '</STYLE>', 'The CSS must not contain "&lt;/STYLE&gt;".' ],
            'style close tag mixed case' => [ '</sTyLe>', 'The CSS must not contain "&lt;/sTyLe&gt;".' ],
            'style close tag in comment' => [ '/*</style>*/', 'The CSS must not contain "&lt;/style&gt;".' ],
            'style close tag (/)'        => [ '</style/', 'The CSS must not contain "&lt;/style/".' ],
            'style close tag (\t)'       => [ "</style\t", "The CSS must not contain \"&lt;/style\t\"." ],
            'style close tag (\f)'       => [ "</style\f", "The CSS must not contain \"&lt;/style\f\"." ],
            'style close tag (\r)'       => [ "</style\r", "The CSS must not contain \"&lt;/style\r\"." ],
            'style close tag (\n)'       => [ "</style\n", "The CSS must not contain \"&lt;/style\n\"." ],
            'style close tag (" ")'      => [ '</style ', 'The CSS must not contain "&lt;/style ".' ],
            'truncated "<"'              => [ '<', 'The CSS must not end in "&lt;".' ],
            'truncated "</"'             => [ '</', 'The CSS must not end in "&lt;/".' ],
            'truncated "</s"'            => [ '</s', 'The CSS must not end in "&lt;/s".' ],
            'truncated "</ST"'           => [ '</ST', 'The CSS must not end in "&lt;/ST".' ],
            'truncated "</sty"'          => [ '</sty', 'The CSS must not end in "&lt;/sty".' ],
            'truncated "</STYL"'         => [ '</STYL', 'The CSS must not end in "&lt;/STYL".' ],
            'truncated "</stYle"'        => [ '</stYle', 'The CSS must not end in "&lt;/stYle".' ],
        ];
    }
}
