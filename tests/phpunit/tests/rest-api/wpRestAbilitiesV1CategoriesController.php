...
class Tests_REST_API_WpRestAbilitiesV1CategoriesController extends WP_UnitTestCase
{
    ...
    {
        return [
            'Uppercase'         => [ 'Data-Retrieval' ],
            '@ symbol'          => [ 'data@retrieval' ],
            'space'             => [ 'data retrieval' ],
            'dot'               => [ 'data.retrieval' ],
            'underscore'        => [ 'data_retrieval' ],
            'URL encoded space' => [ 'data%20retrieval' ],
        ];
    }
    ...
    public function data_invalid_pagination_params_provider(): array
    {
        return [
            ...
            'Zero per page'        => [ [ 'per_page' => 0 ] ],
            'Negative per page'    => [ [ 'per_page' => -10 ] ],
            'Exceeds maximum'      => [ [ 'per_page' => 1000 ] ],
            'Non-numeric per page' => [ [ 'per_page' => 'all' ] ],
        ];
    }
