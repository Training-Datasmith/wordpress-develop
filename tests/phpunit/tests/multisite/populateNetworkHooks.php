...
if (is_multisite()) :
    ...
    class Tests_Multisite_PopulateNetworkHooks extends WP_UnitTestCase
    {
        ...
        public function test_before_populate_network_hook()
        {
            ...
            add_action('before_populate_network', [ $this, 'hook_action_counter' ], 10, 6);
            add_action('after_populate_network', [ $this, 'hook_action_counter' ], 10, 6);
            ...
            remove_action('before_populate_network', [ $this, 'hook_action_counter' ], 10);
            remove_action('after_populate_network', [ $this, 'hook_action_counter' ], 10);
        ...
        public function test_populate_network_hook_filter()
        {
            ...
            add_action('before_populate_network', [ $this, 'modify_domain_hook' ], 10, 6);
            ...
            remove_action('before_populate_network', [ $this, 'modify_domain_hook' ], 10);
