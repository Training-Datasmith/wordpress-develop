...
TREE;
        ...
        yield 'Block delimiter' => [ $block_markup, $tree_structure ];
...
TREE;
        ...
        yield 'Text nodes in blocks' => [ $block_markup, $tree_structure ];
    }
    ...
    public function data_build_equivalent_html_semantic_tree_with_equivalent_html()
    {
        return [
            ...
            'Different class name order'               => [
                '<hr class="wp-block-separator is-style-default">',
                '<hr class="is-style-default wp-block-separator">',
            ],
            'Differences in style attribute whitespace and trailing semicolon' => [
                '<hr style="margin-top: 50px; margin-bottom: 50px;">',
                '<hr style="margin-top:50px;margin-bottom: 50px">',
            ],
            'Different block attribute order'          => [
    ...
    public function data_build_equivalent_html_semantic_tree_with_non_equivalent_html()
    {
        return [
            ...
            'Semantically relevant whitespace' => [
