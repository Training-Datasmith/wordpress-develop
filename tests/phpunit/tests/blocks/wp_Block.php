...
HTML
                ,
                'expected_styles'         => [ 'static-view-style', 'static-child-view-style', 'dynamic-view-style' ],
                'expected_scripts'        => [ 'static-view-script', 'static-child-view-script', 'dynamic-view-script' ],
                'expected_script_modules' => [ 'static-view-script-module', 'static-child-view-script-module', 'dynamic-view-script-module' ],
            ],
            'all_printed_with_extra_asset_via_filter' => [
                'set_up'                  => static function () {
                    add_filter(
                        'render_block_core/dynamic',
                        static function ($content) {
                            wp_enqueue_style('dynamic-extra', home_url('/dynamic-extra.css'), [], null);
...
HTML
                ,
                'expected_styles'         => [ 'static-view-style', 'dynamic-extra', 'static-child-view-style', 'dynamic-view-style' ],
                'expected_scripts'        => [ 'static-view-script', 'static-child-view-script', 'dynamic-view-script' ],
                'expected_script_modules' => [ 'static-view-script-module', 'static-child-view-script-module', 'dynamic-view-script-module' ],
            ],
            'dynamic_hidden_assets_omitted'           => [
                'set_up'                  => static function () {
...
HTML
                ,
                'expected_styles'         => [ 'static-view-style', 'static-child-view-style' ],
                'expected_scripts'        => [ 'static-view-script', 'static-child-view-script' ],
                'expected_script_modules' => [ 'static-view-script-module', 'static-child-view-script-module' ],
            ],
            'dynamic_hidden_assets_included'          => [
                'set_up'                  => static function () {
                    add_filter('render_block_core/dynamic', '__return_empty_string');
                    add_filter(
...
HTML
            ...
            'static_hidden_assets_omitted'            => [
                ...
                'expected_styles'         => [],
                'expected_scripts'        => [],
                'expected_script_modules' => [],
            ],
            'static_child_hidden_assets_omitted'      => [
                'set_up'                  => static function () {
...
HTML
                ,
                'expected_styles'         => [ 'static-view-style', 'dynamic-view-style' ],
                'expected_scripts'        => [ 'static-view-script', 'dynamic-view-script' ],
                'expected_script_modules' => [ 'static-view-script-module', 'dynamic-view-script-module' ],
            ],
            'last_static_child_hidden_assets_omitted' => [
                'set_up'                  => static function () {
                    add_filter(
...
HTML
            ...
            'admin_bar_assets_enqueued_in_block'      => [
                'set_up'                  => static function () {
                ...
                'expected_styles'         => [ 'static-view-style', 'admin-bar' ],
                'expected_scripts'        => [ 'static-view-script', 'admin-bar' ],
                'expected_script_modules' => [ 'static-view-script-module' ],
            ],
            'enqueues_in_wp_head_block'               => [
                'set_up'                  => static function () {
                    ...
                    add_action(
                        'wp_enqueue_scripts',
                        static function () {
                            wp_enqueue_script('for-footer', '/footer.js', [], null, [ 'in_footer' => true ]);
                        }
                    );
                    add_action(
                        'wp_head',
                        static function () {
                            wp_enqueue_style('for-footer', '/footer.css', [], null);
                        },
                        10000
                    );
                },
                ...
                'expected_rendered_block' => '',
                'expected_styles'         => [ 'for-footer' ],
                'expected_scripts'        => [ 'for-footer' ],
                'expected_script_modules' => [],
            ],
        ];
    }
    ...
    public function test_render_enqueues_scripts_and_styles(?Closure $set_up, string $block_markup, string $expected_rendered_block, array $expected_styles, array $expected_scripts, array $expected_script_modules)
    {
        ...
        $this->registry->register(
            'core/static',
            [
                'view_style_handles'     => [ 'static-view-style' ],
                'view_script_handles'    => [ 'static-view-script' ],
                'view_script_module_ids' => [ 'static-view-script-module' ],
            ]
        );
        ...
        $this->registry->register(
            'core/static-child',
            [
                'view_style_handles'     => [ 'static-child-view-style' ],
                'view_script_handles'    => [ 'static-child-view-script' ],
                'view_script_module_ids' => [ 'static-child-view-script-module' ],
            ]
        );
        ...
        $this->registry->register(
            ...
            [
                ...
                'view_style_handles'     => [ 'dynamic-view-style' ],
                'view_script_handles'    => [ 'dynamic-view-script' ],
                'view_script_module_ids' => [ 'dynamic-view-script-module' ],
            ]
        );
