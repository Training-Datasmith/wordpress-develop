...
class Tests_User extends WP_UnitTestCase
{
    ...
    public function test_count_many_users_posts_is_cached()
    {
        ...
        self::factory()->post->create([ 'post_author' => $user_1 ]);
        self::factory()->post->create([ 'post_author' => $user_2 ]);

        // Warm the cache.
        $count1 = count_many_users_posts([ $user_1, $user_2 ], 'post', false);

        // Ensure cache is hit for second call.
        $start_queries = get_num_queries();
        $count2        = count_many_users_posts([ $user_1, $user_2 ], 'post', false);
    ...
    {
        return [
            'single post string vs array'  => [
                [ [ 0 ], 'post' ],
                [ [ 0 ], [ 'post' ] ],
            ],
            'duplicate post type in array' => [
                [ [ 0 ], [ 'post', 'post' ] ],
                [ [ 0 ], [ 'post' ] ],
            ],
            'different post type order'    => [
                [ [ 0 ], [ 'post', 'page' ] ],
                [ [ 0 ], [ 'page', 'post' ] ],
            ],
    ...
    public function test_count_many_users_posts_cache_invalidation()
    {
        ...
        $counts1 = count_many_users_posts([ $user_1, $user_2 ], 'post', false);
        $this->assertSame(
            [
                $user_1 => '1',
                $user_2 => '1',
        ...
        $counts2 = count_many_users_posts([ $user_1, $user_2 ], 'post', false);
        $this->assertSame(
            [
                $user_1 => '2',
                $user_2 => '1',
    ...
    public function test_different_post_types_use_different_caches()
    {
        ...
        $start_queries = get_num_queries();
        $count1        = count_many_users_posts([ $user_id ], 'post', false);
        $end_queries   = get_num_queries();
        ...
        $start_queries = get_num_queries();
        $count2        = count_many_users_posts([ $user_id ], 'page', false);
        $end_queries   = get_num_queries();
    ...
    public function test_different_users_use_different_caches()
    {
        ...
        $start_queries = get_num_queries();
        $count1        = count_many_users_posts([ $user_1 ], 'post', false);
        $end_queries   = get_num_queries();
        ...
        $start_queries = get_num_queries();
        $count2        = count_many_users_posts([ $user_2 ], 'post', false);
        $end_queries   = get_num_queries();
    ...
    public function test_wp_user_roles_property_is_sequential_array()
    {
        ...
        $this->assertSame([], $user->roles, 'After removing all roles, $user->roles should be an empty array.');

        $user->add_role('author');
        $user->add_role('subscriber');
        $this->assertSame([ 'author', 'subscriber' ], $user->roles, 'After adding multiple roles, $user->roles should contain added roles.');
    ...
    public function test_set_password_action_fires_during_wp_insert_user()
    {
        ...
        add_action('wp_set_password', [ $mock_action, 'action' ], 10, 3);
