...
class Tests_HtmlApi_WpHtmlProcessorModifiableText extends WP_UnitTestCase
{
    ...
    public static function data_modifiable_text_special_textarea(): array
    {
        return [
            ...
            'Leading carriage return + newline' => [
                "\r\nCR-N",
                "<textarea>\n\nCR-N</textarea>",
            ],
        ];
    ...
    public static function data_set_modifiable_fails_non_atomic_tags(): array
    {
        return [
            ...
            'svg PATH'                   => [ '<svg><path></path></svg>', 'PATH' ],
            'svg PATH (self-closing)'    => [ '<svg><path /></svg>', 'PATH' ],
            'math MTEXT'                 => [ '<math><mtext></mtext></math>', 'MTEXT' ],
            'math MSPACE (self-closing)' => [ '<math><mspace /></math>', 'MSPACE' ],

            // Foreign elements with atomic-like tags.
            'svg TEXTAREA'               => [ '<svg><textarea></textarea></svg>', 'TEXTAREA' ],
            'svg TITLE'                  => [ '<svg><title></title></svg>', 'TITLE' ],
            'svg STYLE'                  => [ '<svg><style></style></svg>', 'STYLE' ],
            'svg SCRIPT'                 => [ '<svg><script></script></svg>', 'SCRIPT' ],
            'math TEXTAREA'              => [ '<math><textarea></textarea></math>', 'TEXTAREA' ],
            'math TITLE'                 => [ '<math><title></title></math>', 'TITLE' ],
            'math STYLE'                 => [ '<math><style></style></math>', 'STYLE' ],
            'math SCRIPT'                => [ '<math><script></script></math>', 'SCRIPT' ],
        ];
    }
}
