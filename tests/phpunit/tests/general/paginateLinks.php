...
EXPECTED;
    ...
    {
        return [
            'pretty permalinks'                => [ 'page/%#%/', home_url('/page/2/'), home_url('/page/3/'), home_url('/page/50/') ],
            'plain permalinks'                 => [ '?page=%#%', home_url('/?page=2'), home_url('/?page=3'), home_url('/?page=50') ],
            'custom format - html extension'   => [ 'page/%#%.html', home_url('/page/2.html'), home_url('/page/3.html'), home_url('/page/50.html') ],
            'custom format - hyphen separated' => [ 'page-%#%', home_url('/page-2'), home_url('/page-3'), home_url('/page-50') ],
            'custom format - fragment'         => [ '#%#%', home_url('/#2'), home_url('/#3'), home_url('/#50') ],
        ];
    }
