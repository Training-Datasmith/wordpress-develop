...
class Tests_Admin_wpSiteHealth extends WP_UnitTestCase
{
    ...
    public function test_get_test_opcode_cache_return_structure()
    {
        ...
        $this->assertContains($result['status'], [ 'good', 'recommended' ], 'Status must be good or recommended.');
    }
