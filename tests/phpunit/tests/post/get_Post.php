...
class Tests_Post_GetPost extends WP_UnitTestCase
{
    ...
    public static function set_up_before_class(): void
    {
        ...
        $wpdb->update(
            $wpdb->posts,
            [ 'post_title' => 'Test <script>console.log("Hello, World!")</script> Title' ],
            [ 'ID' => self::$post_id ]
        );
    ...
    public function data_provider_to_test_get_post(): array
    {
        return [
            ...
            'Object with non-raw filter and ID'    => [
                'input'       => fn () => (object) [
                    'ID'     => self::$post_id,
                    'filter' => 'edit',
                ],
            ...
            'Object with non-raw filter and NO ID' => [
                'input'       => fn () => (object) [ 'filter' => 'edit' ],
                'output'      => OBJECT,
                'filter'      => 'raw',
                'expected_id' => fn () => null,
            ],
            ...
            'Empty input and no global post'       => [
                'input'       => fn () => null,
                'output'      => OBJECT,
                'filter'      => 'raw',
                'expected_id' => fn () => null,
            ],
            '0 input and no global post'           => [
                'input'       => fn () => 0,
                'output'      => OBJECT,
                'filter'      => 'raw',
                'expected_id' => fn () => null,
