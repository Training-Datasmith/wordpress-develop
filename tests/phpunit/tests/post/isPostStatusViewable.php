...
class Tests_Post_IsPostStatusViewable extends WP_UnitTestCase
{
    ...
    {
        return [
            'false for non-publicly queryable types' => [
                [
            ...
            'true for publicly queryable types'      => [
                [
            ...
            'false for built-in non-public types'    => [
                [
                    'publicly_queryable' => false,
                    '_builtin'           => true,
                    'public'             => false,
            ...
            'false for non-built-in public types'    => [
                [
                    'publicly_queryable' => false,
                    '_builtin'           => false,
                    'public'             => true,
            ...
            'true for built-in public types'         => [
                [
                    'publicly_queryable' => false,
                    '_builtin'           => true,
                    'public'             => true,
    ...
    public static function data_built_in_and_unregistered_status_types()
    {
        return [
            ...
            'trash'             => [ 'trash', false ],
            'auto-draft'        => [ 'auto-draft', false ],
            'inherit'           => [ 'inherit', false ],
            'request-pending'   => [ 'request-pending', false ],
            'request-confirmed' => [ 'request-confirmed', false ],
            'request-failed'    => [ 'request-failed', false ],
            'request-completed' => [ 'request-completed', false ],

            // Various unregistered statuses.
            'unregistered'      => [ 'unregistered-status', false ],
            'false'             => [ false, false ],
            'true'              => [ true, false ],
            'number 20'         => [ 20, false ],
            'null'              => [ null, false ],
