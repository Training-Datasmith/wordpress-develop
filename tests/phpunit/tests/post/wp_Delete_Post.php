...
class Tests_Post_WpDeletePost extends WP_UnitTestCase
{
    ...
    {
        return wp_next_scheduled($hook, [ 0 => $post_id ]);
    }
    ...
    public function test_wp_delete_post_actions()
    {
        ...
        foreach ([ 'before_delete_post', 'delete_post_post', 'delete_post', 'deleted_post_post', 'deleted_post', 'after_delete_post' ] as $action) {
