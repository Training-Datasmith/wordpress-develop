...
class Tests_Comment_Query extends WP_UnitTestCase
{
    ...
    public function test_note_type_exclusion(array $query_args, array $expected_types)
    {
        ...
        $query = new WP_Comment_Query();
        $found = $query->query(array_merge($query_args, [ 'fields' => 'ids' ]));
    ...
    {
        return [
            'default query excludes note'        => [
                'query_args'     => [],
                'expected_types' => [ 'comment', 'pingback' ],
            ],
            'empty type parameter excludes note' => [
                'query_args'     => [ 'type' => '' ],
                'expected_types' => [ 'comment', 'pingback' ],
            ],
            'type all includes note'             => [
                'query_args'     => [ 'type' => 'all' ],
                'expected_types' => [ 'comment', 'pingback', 'note' ],
            ],
            'explicit note type'                 => [
                'query_args'     => [ 'type' => 'note' ],
                'expected_types' => [ 'note' ],
            ],
            'type__in with note'                 => [
                'query_args'     => [ 'type__in' => [ 'note' ] ],
                'expected_types' => [ 'note' ],
            ],
            'type__in with note and pingback'    => [
                'query_args'     => [ 'type__in' => [ 'note', 'pingback' ] ],
                'expected_types' => [ 'note', 'pingback' ],
            ],
            'type pings excludes note'           => [
                'query_args'     => [ 'type' => 'pings' ],
                'expected_types' => [ 'pingback' ],
            ],
            'type__not_in with note'             => [
                'query_args'     => [ 'type__not_in' => [ 'note' ] ],
                'expected_types' => [ 'comment', 'pingback' ],
            ],
        ];
    }
    ...
    public function test_note_type_not_duplicated_in_type__not_in()
    {
        ...
        $this->assertSameSets([ $comments['comment'], $comments['pingback'] ], $found);
