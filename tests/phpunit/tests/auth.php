...
class Tests_Auth extends WP_UnitTestCase
{
    ...
    {
        return [
            'no spaces'                => [ 'a password with no trailing or leading spaces' ],
            'trailing space'           => [ 'a password with trailing spaces ' ],
            'leading space'            => [ ' a password with leading spaces' ],
            'leading and trailing'     => [ ' a password with trailing and leading spaces ' ],
            'multiple leading spaces'  => [ '    a password with multiple leading spaces' ],
            'multiple trailing spaces' => [ 'a password with multiple trailing spaces    ' ],
        ];
    }
    ...
    {
        return [
            'leading whitespace'  => [ ' pass with leading whitespace', 'pass with leading whitespace' ],
            'trailing whitespace' => [ 'pass with trailing whitespace ', 'pass with trailing whitespace' ],
            'both whitespace'     => [ ' pass with whitespace ', 'pass with whitespace' ],
            'new line'            => [ "pass with new line \n", 'pass with new line' ],
            'vertical tab'        => [ "pass with vertical tab o_O\x0B", 'pass with vertical tab o_O' ],
        ];
    }
