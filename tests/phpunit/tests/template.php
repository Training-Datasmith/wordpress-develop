...
class Tests_Template extends WP_UnitTestCase
{
     ...
     * @var array
     */
    public const RESTORED_CONFIG_OPTIONS = [
        'display_errors',
        'error_reporting',
        'log_errors',
        'error_log',
    ...
    public function test_wp_start_template_enhancement_output_buffer_for_json(): void
    {
        ...
        $mock_filter_callback = new MockAction();
        add_filter('wp_template_enhancement_output_buffer', [ $mock_filter_callback, 'filter' ]);
    ...
    public function data_provider_to_test_wp_finalize_template_enhancement_output_buffer_with_errors_while_processing(): array
    {
        ...
        $tests = [
            ...
            'notice_with_display_errors_stderr'       => [
                'ini_config_options'        => array_merge(
                    $log_and_display_all,
                    [
        ...
        $tests_error_reporting_warnings_and_above = [];
        ...
        $tests_without_display_or_log_errors = [];
        foreach ($tests as $name => $test) {
            $test['ini_config_options']['display_errors'] = false;
    ...
    public function data_wp_load_classic_theme_block_styles_on_demand(): array
    {
        return [
            ...
            'classic_theme_with_output_buffer_blocked' => [
                'theme'                   => 'default',
                'set_up'                  => static function () {
                    add_filter('wp_should_output_buffer_template_for_enhancement', '__return_false');
                },
            ...
            'classic_theme_with_should_load_separate_core_block_assets_opt_out' => [
                'theme'                   => 'default',
                'set_up'                  => static function () {
            ...
            'classic_theme_with_should_load_block_assets_on_demand_out_out' => [
                'theme'                   => 'default',
                'set_up'                  => static function () {
            ...
            'classic_theme_without_any_opt_out'        => [
                'theme'                   => 'default',
                'set_up'                  => static function () {
                },
                'expected_load_separate'  => true,
    ...
    public function data_wp_hoist_late_printed_styles(): array
    {
        ...
        return [
            'standard_classic_theme_config_with_min_styles_inlined' => [
                'set_up'            => null,
                'inline_size_limit' => 0,
                'expected_styles'   => [
            ...
            'standard_classic_theme_config_with_max_styles_inlined' => [
                'set_up'            => null,
            ...
            'no_styles_at_enqueued_block_assets'          => [
                'set_up'            => static function () {
                    add_action(
                        'wp_enqueue_scripts',
                        static function () {
                ...
                'set_up'            => static function () {
                    add_filter(
                        ...
                        static function ($handles) {
                            return array_values(array_diff($handles, [ 'global-styles' ]));
                        }
                    );
                },
                'inline_size_limit' => PHP_INT_MAX,
            ...
            'standard_classic_theme_config_extra_block_library_inline_style' => [
                'set_up'            => static function () {
                    add_action(
            ...
            'classic_theme_opt_out_separate_block_styles' => [
                'set_up'            => static function () {
                    add_filter('should_load_separate_core_block_assets', '__return_false');
                },
                'inline_size_limit' => 0,
            ...
            'wp_print_footer_scripts_removed'             => [
                'set_up'            => static function () {
            ...
            'override_block_library_inline_style_late'    => [
                'set_up'            => static function () {
                    add_action(
                        'enqueue_block_assets',
                        function (): void {
                            // This tests what happens when the placeholder comment gets replaced unexpectedly.
                            wp_styles()->registered['wp-block-library']->extra['after'] = [ '/* OVERRIDDEN! */' ];
                        }
                    );
                },
                'inline_size_limit' => 0,
    ...
    public function test_wp_hoist_late_printed_styles(?Closure $set_up, int $inline_size_limit, array $expected_styles): void
    {
        ...
        wp_register_style('third-party-test-block', 'https://example.com/third-party-test-block.css', [], null);
        register_block_type(
            'third-party/test',
            [
                'style_handles' => [ 'third-party-test-block' ],
            ]
        );
        ...
        add_action(
            'enqueue_block_assets',
            static function () {
                wp_enqueue_style('custom-block-styles', 'https://example.com/custom-block-styles.css', [], null);
            }
        );
        ...
        wp_enqueue_style('late', 'https://example.com/late-style.css', [], null);
